import{a as e,n as t,s as n,t as r}from"./typography.Dt-sBkj4.js";var i=class extends t{static formAssociated=!0;static properties={label:{type:String},size:{type:String,reflect:!0},disabled:{type:Boolean,reflect:!0},name:{type:String,reflect:!0},labelPosition:{type:String,attribute:`label-position`,reflect:!0},checked:{type:Boolean,reflect:!0}};internals;constructor(){super(),this.label=``,this.size=`md`,this.disabled=!1,this.labelPosition=`after`,this.checked=!1,this.internals=this.attachInternals()}connectedCallback(){super.connectedCallback(),this.syncFormValue()}syncFormValue(){this.internals.setFormValue(this.checked?`on`:null),this.internals.ariaChecked=String(this.checked)}toggle=()=>{this.disabled||(this.checked=!this.checked,this.syncFormValue(),this.dispatchEvent(new CustomEvent(`change`,{detail:{checked:this.checked},bubbles:!0,composed:!0})))};onKeydown=e=>{(e.key===` `||e.key===`Enter`)&&(e.preventDefault(),this.toggle())};render(){let t=this.label?e`<span class="label typography-body-md" part="label">${this.label}</span>`:null;return e`
      <button
        type="button"
        class="root"
        role="switch"
  ...
  `]};customElements.get(`esa-switch-toggle`)||customElements.define(`esa-switch-toggle`,i);