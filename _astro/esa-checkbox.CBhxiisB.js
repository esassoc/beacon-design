import{a as e,n as t,o as n,r,s as i,t as a}from"./typography.Dt-sBkj4.js";import{t as o}from"./a11y.CplpE3OP.js";var s={xs:`body-2xs`,sm:`body-xs`,md:`body-md`,lg:`body-lg`},c=n`<polyline points="20 6 9 17 4 12"></polyline>`,l=n`<line x1="5" y1="12" x2="19" y2="12"></line>`,u=class extends t{static formAssociated=!0;static properties={label:{type:String},size:{type:String,reflect:!0},disabled:{type:Boolean,reflect:!0},name:{type:String,reflect:!0},indeterminate:{type:Boolean,reflect:!0},checked:{type:Boolean,reflect:!0}};internals;constructor(){super(),this.label=``,this.size=`md`,this.disabled=!1,this.indeterminate=!1,this.checked=!1,this.internals=this.attachInternals()}connectedCallback(){super.connectedCallback(),this.syncFormValue()}syncFormValue(){this.internals.setFormValue(this.checked?`on`:null),this.internals.ariaChecked=this.indeterminate?`mixed`:String(this.checked)}toggle=()=>{this.disabled||(this.checked=!this.checked,this.syncFormValue(),this.dispatchEvent(new CustomEvent(`change`,{detail:{checked:this.checked},bubbles:!0,composed:!0})))};onKeydown=e=>{(e.key===` `||e.key===`Enter`)&&(e.preventDefault(),this.toggle())};render(){let t=this.getAttribute(`aria-label`);return e`
      <label class="wrapper" @keydown=${this.onKeydown} @click=${this.toggle}>
        ...
        <span
          ...
          aria-label=${!this.label&&t?t:r}
          aria-checked=${this.indeterminate?`mixed`:String(this.checked)}
          aria-disabled=${String(this.disabled)}
          tabindex=${this.disabled?-1:0}
        >
          ${this.indeterminate?e`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${l}</svg>`:this.checked?e`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${c}</svg>`:null}
        </span>
        ${this.label?e`<span id="label" class="label typography-${s[this.size]}">${this.label}</span>`:null}
      </label>
    `}static styles=[a,o,i`
    :host {
      --_checkbox-size: 20px;
  ...
  `]};customElements.get(`esa-checkbox`)||customElements.define(`esa-checkbox`,u);