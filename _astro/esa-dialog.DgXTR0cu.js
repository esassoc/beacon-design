import{a as e,n as t,r as n,s as r,t as i}from"./typography.Dt-sBkj4.js";import{t as a}from"./boolish.oUPlfJhN.js";var o=class extends t{static properties={open:{type:Boolean,reflect:!0},heading:{type:String},showCloseButton:{type:Boolean,attribute:`show-close-button`,converter:a},size:{type:String,reflect:!0}};constructor(){super(),this.open=!1,this.heading=``,this.showCloseButton=!0,this.size=`md`}get dialogEl(){return this.renderRoot.querySelector(`dialog`)}updated(e){if(!e.has(`open`))return;let t=this.dialogEl;t&&(this.open?t.open||t.showModal():t.close())}show(){this.open=!0}close(){this.open&&(this.open=!1,this.dispatchEvent(new CustomEvent(`close`,{bubbles:!0,composed:!0})))}onNativeClose=()=>{this.close()};connectedCallback(){super.connectedCallback(),`closedBy`in HTMLDialogElement.prototype||this.addEventListener(`click`,this.onLightDismiss)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.onLightDismiss)}onLightDismiss=e=>{let t=this.dialogEl;if(!t||!this.open||e.composedPath()[0]!==t)return;let n=t.getBoundingClientRect();n.top<=e.clientY&&e.clientY<=n.top+n.height&&n.left<=e.clientX&&e.clientX<=n.left+n.width||this.close()};render(){let t=this.heading||this.showCloseButton||!!this.querySelector(`[slot="header"]`),r=this.querySelector(`[slot="header"]`)?.textContent?.trim(),i=!!this.heading;return e`
      <dialog
        class="esa-dialog"
        closedby="any"
        aria-labelledby=${i?`esa-dialog-title`:n}
        aria-label=${i?n:r||`Dialog`}
  ...
  `]};customElements.get(`esa-dialog`)||customElements.define(`esa-dialog`,o);