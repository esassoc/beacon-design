import"./esa-dialog.ChrbSrDC.js";import"./esa-side-dialog.dYSTc6GU.js";import"./esa-select.DL8M7uWj.js";import"./esa-text-field.astro_astro_type_script_index_0_lang.Cl9GLXNR.js";import"./BcnDiscussion.astro_astro_type_script_index_0_lang.DM5TVSg9.js";import"./esa-date-picker.astro_astro_type_script_index_0_lang.UskZtLM7.js";import"./esa-file-list.WWpmmJYu.js";import{i as v,b as s,a as h}from"./lit-element.C8p3bJxG.js";class b extends v{constructor(){super(),this.previousFocus=null,this.confirm=()=>this.resolve(!0),this.cancel=()=>this.resolve(!1),this.onKeydown=e=>{if(this.open){if(e.key==="Escape")e.preventDefault(),this.cancel();else if(e.key==="Tab"){const r=this.renderRoot,n=Array.from(r.querySelectorAll("button:not([disabled])"));if(n.length===0)return;const c=n[0],m=n[n.length-1],g=r.activeElement;e.shiftKey&&g===c?(e.preventDefault(),m.focus()):!e.shiftKey&&g===m&&(e.preventDefault(),c.focus())}}},this.open=!1,this.heading="",this.message="",this.variant="default",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.showIcon=!0}static{this.properties={open:{type:Boolean,reflect:!0},heading:{type:String},message:{type:String},variant:{type:String,reflect:!0},confirmLabel:{type:String,attribute:"confirm-label"},cancelLabel:{type:String,attribute:"cancel-label"},showIcon:{type:Boolean,attribute:"show-icon"}}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeydown)}updated(e){e.has("open")&&(this.open?(this.previousFocus=document.activeElement,requestAnimationFrame(()=>{this.renderRoot.querySelector(".esa-confirm-dialog__confirm")?.focus()})):this.previousFocus&&(this.previousFocus.focus?.(),this.previousFocus=null))}show(){this.open=!0}resolve(e){this.open=!1,this.dispatchEvent(new CustomEvent(e?"confirm":"cancel",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("resolved",{detail:{confirmed:e},bubbles:!0,composed:!0}))}icon(){return this.showIcon?this.variant==="danger"?s`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`:this.variant==="warning"?s`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`:s`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`:null}render(){return this.open?s`
  ...
  `}}customElements.get("esa-confirm-dialog")||customElements.define("esa-confirm-dialog",b);const i=JSON.parse(document.getElementById("edit-meta").textContent||"{}"),t=o=>document.getElementById(o),a=(o,e)=>{const r=document.getElementById(o);r&&(r.value=e)},_=(o,e,r)=>{const n=document.getElementById(o);n&&(n.options=e.map(c=>({value:c,label:c})),r!==void 0&&(n.value=r))},y=t("source-drawer"),u=(o,e)=>{const r=document.createElement("a");r.href=o,r.download=e,document.body.appendChild(r),r.click(),r.remove()},k=JSON.parse(document.getElementById("doc-files-data").textContent||"[]"),l=t("doc-files"),d=l.dataset.src??"#";l.files=k.map(o=>({name:o,href:d}));l.addEventListener("click",o=>{o.composedPath().some(e=>e instanceof HTMLAnchorElement)&&(o.preventDefault(),y.open=!0)});l.addEventListener("download",o=>{const{file:e}=o.detail;u(d,e?.name??"")});t("download-coversheet").addEventListener("click",()=>u(d,`Source-Coversheet_${i.docTitle??"source"}.pdf`));const p=t("delete-confirm");t("delete-doc").addEventListener("click",()=>p.open=!0);p.addEventListener("confirm",()=>{window.location.hash="#data-catalog/source-documents"});const f=t("edit-dialog");a("d-name",i.docTitle??"");_("d-project",[i.project,"Harbor Logistics Center","Foothill Substation Upgrade"],i.project);a("d-amended",i.latestAmendment??"");a("d-ref",i.referenceNumber??"");a("d-agency",i.approvingAgency??"");a("d-contact",i.agencyContact??"");a("d-signatory",i.agencySignatory??"");a("d-desc",i.description??"");t("edit-doc").addEventListener("click",()=>f.open=!0);t("ed-cancel").addEventListener("click",()=>f.open=!1);t("ed-save").addEventListener("click",()=>f.open=!1);
