import{i as o,b as e,a as c}from"./lit-element.C8p3bJxG.js";class l extends o{constructor(){super(),this.onAction=()=>{this.dispatchEvent(new CustomEvent("action",{bubbles:!0,composed:!0})),this.dismiss()},this.dismiss=()=>{this.dispatchEvent(new CustomEvent("dismiss",{bubbles:!0,composed:!0}))},this.message="",this.variant="info",this.action="",this.dismissable=!0,this.icon=""}static{this.properties={message:{type:String},variant:{type:String,reflect:!0},action:{type:String},dismissable:{type:Boolean},icon:{type:String}}}renderIcon(){switch(this.variant){case"success":return e`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>`;case"warning":return e`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`;case"danger":return e`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`;default:return e`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`}}render(){return e`
  ...
  `}}customElements.get("esa-snackbar-item")||customElements.define("esa-snackbar-item",l);class u extends o{constructor(){super(),this.nextId=0,this.snackbars=[]}static{this.properties={snackbars:{state:!0}}}show(s){const a={variant:"info",duration:5e3,dismissable:!0,...s};if(a.uniqueKey){const i=this.snackbars.find(d=>d.uniqueKey===a.uniqueKey);if(i)return i.id}const r=`esa-snackbar-${this.nextId++}`,n={...a,id:r,timer:null};return a.duration&&a.duration>0&&(n.timer=setTimeout(()=>this.dismiss(r),a.duration)),this.snackbars=[...this.snackbars,n],r}success(s,a){return this.show({...a,message:s,variant:"success"})}info(s,a){return this.show({...a,message:s,variant:"info"})}warning(s,a){return this.show({...a,message:s,variant:"warning"})}danger(s,a){return this.show({...a,message:s,variant:"danger"})}dismiss(s){const a=this.snackbars.find(r=>r.id===s);a?.timer&&clearTimeout(a.timer),this.snackbars=this.snackbars.filter(r=>r.id!==s)}clearAll(){this.snackbars.forEach(s=>s.timer&&clearTimeout(s.timer)),this.snackbars=[]}disconnectedCallback(){super.disconnectedCallback(),this.snackbars.forEach(s=>s.timer&&clearTimeout(s.timer))}render(){return e`
  ...
  `}}customElements.get("esa-snackbar-container")||customElements.define("esa-snackbar-container",u);function h(){const t=document.querySelector("esa-snackbar-container");if(t)return t;const s=document.createElement("esa-snackbar-container");return document.body.appendChild(s),s}function m(t,s="info",a=3e3){return h().show({message:t,variant:s,duration:a})}export{h as s,m as t};
