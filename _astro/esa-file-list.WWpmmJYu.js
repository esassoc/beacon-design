import{i as a,b as t,a as n}from"./lit-element.C8p3bJxG.js";class s extends a{static{this.properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0}}}constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,i,r){this.dispatchEvent(new CustomEvent(e,{detail:{file:i,index:r},bubbles:!0,composed:!0}))}onRemove(e){const i=this.files[e];this.files=this.files.filter((r,o)=>o!==e),this.emit("remove",i,e)}render(){return this.files.length?t`
      <ul class="list">
        ${this.files.map((e,i)=>t`<li class="file">
  ...
  `}}customElements.get("esa-file-list")||customElements.define("esa-file-list",s);
