import{i as m,b as t,t as p,a as b}from"./typography.C7xuE2z_.js";import{a as h}from"./announcer.dkeh-00N.js";import{d as f}from"./overlay.BBIxLHx2.js";import{b as g}from"./boolish.DOQu-9JQ.js";class k extends m{constructor(){super(),this.onAction=()=>{this.dispatchEvent(new CustomEvent("action",{bubbles:!0,composed:!0})),this.dismiss()},this.dismiss=()=>{this.dispatchEvent(new CustomEvent("dismiss",{bubbles:!0,composed:!0}))},this.message="",this.variant="info",this.action="",this.dismissable=!0,this.icon=""}static{this.properties={message:{type:String},variant:{type:String,reflect:!0},action:{type:String},dismissable:{type:Boolean,converter:g},icon:{type:String}}}renderIcon(){switch(this.variant){case"success":return t`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>`;case"warning":return t`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`;case"danger":return t`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>`;default:return t`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`}}render(){return t`
  ...
  `]}}customElements.get("esa-snackbar-item")||customElements.define("esa-snackbar-item",k);let u=!1;class v extends m{constructor(){super(),this.nextId=0,this.previousFocus=null,this.pauseAll=()=>{for(const e of this.snackbars)e.timer&&(clearTimeout(e.timer),e.timer=null,e.remaining=Math.max(0,e.remaining-(Date.now()-e.startedAt)))},this.resumeAll=()=>{for(const e of this.snackbars)!e.timer&&e.remaining>0&&this.startTimer(e)},this.onKeydown=e=>{e.key!=="Escape"||this.snackbars.length===0||(e.stopPropagation(),this.dismiss(this.snackbars[this.snackbars.length-1].id))},this.onFocusIn=e=>{const s=e.relatedTarget;s&&!this.contains(s)&&(this.previousFocus=s),this.pauseAll()},this.snackbars=[],this.label="Notifications"}static{this.properties={snackbars:{state:!0},label:{type:String}}}show(e){e.duration===void 0&&!u&&(u=!0,console.info("[esa-snackbar] Toasts now persist until dismissed. The `duration` default changed from 5000 to 0 on 2026-08-16 — a timer the user cannot adjust is WCAG 2.2.1 (Level A). Pass `duration: 5000` to restore auto-dismiss, and read the note on EsaSnackbarConfig.duration before you do."));const s={variant:"info",duration:0,dismissable:!0,...e},r=s.variant==="danger";if(s.uniqueKey){const l=this.snackbars.find(c=>c.uniqueKey===s.uniqueKey);if(l){this.snackbars=this.snackbars.map(i=>i.uniqueKey===s.uniqueKey?{...i,...s,id:i.id,timer:i.timer}:i);const c=this.snackbars.find(i=>i.id===l.id)??l;return h(s.message,{assertive:r}),this.restartTimer(c),c.id}}const o=`esa-snackbar-${this.nextId++}`,a=s.duration??0,d={...s,id:o,timer:null,remaining:a,startedAt:0};return this.snackbars=[...this.snackbars,d],h(s.message,{assertive:r}),this.startTimer(d),o}success(e,s){return this.show({...s,message:e,variant:"success"})}info(e,s){return this.show({...s,message:e,variant:"info"})}warning(e,s){return this.show({...s,message:e,variant:"warning"})}danger(e,s){return this.show({...s,message:e,variant:"danger"})}startTimer(e){e.remaining<=0||(e.startedAt=Date.now(),e.timer=setTimeout(()=>this.dismiss(e.id),e.remaining))}restartTimer(e){e.timer&&clearTimeout(e.timer),e.remaining=e.duration??0,this.startTimer(e)}dismiss(e){const s=this.snackbars.find(a=>a.id===e);s?.timer&&clearTimeout(s.timer);const r=this.renderRoot.activeElement??f(),o=!!r&&this.renderRoot.contains(r);if(this.snackbars=this.snackbars.filter(a=>a.id!==e),o){const a=this.previousFocus;this.previousFocus=null,this.updateComplete.then(()=>{a?.isConnected?a.focus():document.body.focus?.()})}}clearAll(){this.snackbars.forEach(e=>e.timer&&clearTimeout(e.timer)),this.snackbars=[]}disconnectedCallback(){super.disconnectedCallback(),this.snackbars.forEach(e=>e.timer&&clearTimeout(e.timer))}render(){return t`
      <div
  ...
  `}}customElements.get("esa-snackbar-container")||customElements.define("esa-snackbar-container",v);function w(){const n=document.querySelector("esa-snackbar-container");if(n)return n;const e=document.createElement("esa-snackbar-container");return document.body.appendChild(e),e}function C(n,e="info",s=3e3){return w().show({message:n,variant:e,duration:s})}export{w as s,C as t};
