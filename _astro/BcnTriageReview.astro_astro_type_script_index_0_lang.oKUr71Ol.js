import{i as a,b as o,t as n,a as s}from"./typography.C7xuE2z_.js";import{b as l}from"./boolish.DOQu-9JQ.js";import"./esa-select.Dz7SPXZ_.js";import"./a11y.c6v_nqwk.js";class d extends a{static{this.properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0,converter:l}}}constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,t,i){this.dispatchEvent(new CustomEvent(e,{detail:{file:t,index:i},bubbles:!0,composed:!0}))}onRemove(e){const t=this.files[e];this.files=this.files.filter((i,r)=>r!==e),this.emit("remove",t,e)}render(){return this.files.length?o`
      <ul class="list">
