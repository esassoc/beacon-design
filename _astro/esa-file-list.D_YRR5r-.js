import{a as e,n as t,s as n,t as r}from"./typography.Dt-sBkj4.js";import{t as i}from"./boolish.oUPlfJhN.js";var a=class extends t{static properties={files:{type:Array},removable:{type:Boolean,reflect:!0},downloadable:{type:Boolean,reflect:!0,converter:i}};constructor(){super(),this.files=[],this.removable=!1,this.downloadable=!0}emit(e,t,n){this.dispatchEvent(new CustomEvent(e,{detail:{file:t,index:n},bubbles:!0,composed:!0}))}onRemove(e){let t=this.files[e];this.files=this.files.filter((t,n)=>n!==e),this.emit(`remove`,t,e)}render(){return this.files.length?e`
      <ul class="list">
        ${this.files.map((t,n)=>e`<li class="file typography-microcopy-sm-subtle">
            <span class="file__icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M10 9H8" /><path d="M16 13H8" /><path d="M16 17H8" />
              </svg>
            </span>
            ${t.href?e`<a class="file__name" href=${t.href} title=${t.name}>${t.name}</a>`:e`<span class="file__name" title=${t.name}>${t.name}</span>`}
            <span class="file__actions">
              ${this.downloadable?e`<button
                    class="file__btn"
                    type="button"
                    aria-label=${`Download `+t.name}
                    @click=${()=>this.emit(`download`,t,n)}
                  >
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" x2="12" y1="15" y2="3" />
                    </svg>
                  </button>`:null}
              ${this.removable?e`<button
                    class="file__btn file__btn--remove"
                    type="button"
                    aria-label=${`Remove `+t.name}
                    @click=${()=>this.onRemove(n)}
                  >
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  ...
  `]};customElements.get(`esa-file-list`)||customElements.define(`esa-file-list`,a);