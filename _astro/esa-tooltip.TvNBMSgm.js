import{a as e,n as t,s as n,t as r}from"./typography.Dt-sBkj4.js";var i=class extends t{static properties={text:{type:String},position:{type:String,reflect:!0},align:{type:String,reflect:!0},delay:{type:Number},open:{type:Boolean,reflect:!0}};showTimeout=null;constructor(){super(),this.text=``,this.position=`above`,this.align=`center`,this.delay=200,this.open=!1}connectedCallback(){super.connectedCallback(),document.addEventListener(`keydown`,this.onGlobalKeydown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this.onGlobalKeydown),this.showTimeout&&clearTimeout(this.showTimeout)}onGlobalKeydown=e=>{e.key!==`Escape`||!this.open||this.onLeave()};onEnter=()=>{this.open||!this.text||(this.showTimeout=setTimeout(()=>{this.open=!0},this.delay))};onLeave=()=>{this.showTimeout&&=(clearTimeout(this.showTimeout),null),this.open=!1};render(){return e`
      <span
