...
Word and CSV downloads in the rail.

## Key decisions
- NO JSON/API section on action lists (Andy: "but not the API option"); that endpoint exists for obligation lists only.
...
<section class="bcn-lxp" data-list-export-panel="">
  ...
  <template data-list-export-copied=""
    ><span class="esa-icon esa-icon--sm" aria-hidden="true" data-astro-cid-c7ivvrtd=""
      ><svg
        width="16"
        height="16"
        viewBox="0 0 24 24"
