...
<section class="ctb" aria-label="Clear-to-build timeline">
  ...
  <div class="ctb__axisrow" aria-hidden="true">
    ...
    <div class="ctb__axis" id="ctb-axis">
      ...
      ><span class="ctb-tick ctb-tick--today" style="left: 41.6394%">Today</span>
    </div>
    <span></span>
  </div>
    ...
    <li class="ctb-row">
      ...
      <span class="ctb-row__track"
        ><span
          class="ctb-row__bar"
          style="
            left: 41.63943355119826%;
            width: 10.457516339869272%;
