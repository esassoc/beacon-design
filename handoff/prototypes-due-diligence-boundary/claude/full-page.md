...
`beacon` theme of the **prototypes-due-diligence-boundary** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/due-diligence-boundary/
      ...
      <div class="main-nav">
        ...
        <div class="nav-section nav-section--active">
          ...
          <ul class="nav-section__items">
            ...
            <li class="nav-item">
              <a href="/beacon-design/prototypes/due-diligence-boundary" class="nav-sublink active"
                >Project Boundary</a
              >
            </li>
            <li class="nav-item">
    ...
    <div class="modern-layout__content">
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><span class="breadcrumb-item">Almond</span
              ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                ><svg
                  width="16"
                  height="16"
                ...
                >
                  <path d="m9 18 6-6-6-6"></path></svg></span
              ><span class="breadcrumb-item" aria-current="page">Project Boundary</span>
            </div>
          </nav>
        </section>
     ...
     style block already documents. -->
            ...
            <div class="page-layout__utilities">
              <div>
                <a href="/beacon-design/prototypes/due-diligence-siting"
                  ><span
                ...
                ><span id="bd-continue"
                  ><span
                    ...
                    ><button class="esa-button__native typography-microcopy-md" type="button">
                      ...
                      ><span class="esa-button__label">Run constraints check</span>
                    </button></span
                  ></span
                >
              </div>
          ...
          <section class="page-layout__content">
            <div class="stack" data-gap="lg">
              <div class="esa-alert-box esa-alert-box--success typography-body-sm">
                ...
                <div class="esa-alert-box__body">
                  <strong class="esa-alert-box__title typography-label-sm-strong"
                    >Passed Site Screening</strong
                  >
                  <div class="esa-alert-box__message">
                    Almond (screened as Project Almond) passed all five acquisition criteria on
                    2026-06-02 and advanced to Due Diligence.
                    <a href="/beacon-design/prototypes/due-diligence-siting"
                      >Review the screening result →</a
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="sidebar" style="--sidebar-width: 22rem">
                    ...
                    <div class="esa-card__body typography-body-md">
                      <div class="stack" data-gap="md">
                        ...
                        ><esa-text-field
                          ...
                          id="bd-juris"
                          value="Kern County (unincorporated)"
                          size="md"
                          readonly="true"
                        ></esa-text-field>
                      </div>
                ...
                <div class="bcn-bmap" id="bd-root" data-bcn-bmap="" data-prefix="bd">
                  <div class="stack" data-gap="md">
                    <div class="repel bcn-bmap__bar" data-gap="md">
                      ...
                      ></esa-button-toggle
                      ><esa-select id="bd-basemap" size="sm" label="Basemap"></esa-select>
                    </div>
                    <div
                      class="bcn-bmap__surface leaflet-container leaflet-touch leaflet-fade-anim leaflet-grab leaflet-touch-drag leaflet-touch-zoom"
                      id="bd-map"
                      style="height: 560px; position: relative"
                      role="region"
                      aria-label="Almond boundary — draw or edit the site outline"
                      tabindex="0"
                    >
                      <div
                        ...
                        <div class="leaflet-pane leaflet-tile-pane">
                          <div class="leaflet-layer" style="z-index: 1; opacity: 1">
                            ...
                            >
                              <img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5627/12973?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5627/12972?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5626/12973?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5628/12973?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5627/12974?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5626/12972?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5628/12972?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5626/12974?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                              ...
                              /><img
                                alt=""
                                src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/15/5628/12974?access_token=undefined"
                                class="leaflet-tile"
                                style="
                                  width: 256px;
                                  height: 256px;
                            ...
                            <div class="leaflet-draw-section">
                              ...
                              >
                                <a class="leaflet-draw-draw-polygon" href="#" title="Draw a polygon"
                                  ><span class="sr-only">Draw a polygon</span></a
                                ><a
                                  class="leaflet-draw-draw-rectangle"
                                  href="#"
                                  title="Draw a rectangle"
                                  ><span class="sr-only">Draw a rectangle</span></a
                                >
                              </div>
                            ...
                            <div class="leaflet-draw-section">
                              <div class="leaflet-draw-toolbar leaflet-bar">
                                <a class="leaflet-draw-edit-edit" href="#" title="Edit layers"
                                  ><span class="sr-only">Edit layers</span></a
                                ><a class="leaflet-draw-edit-remove" href="#" title="Delete layers"
                                  ><span class="sr-only">Delete layers</span></a
                                >
                              </div>
                              <ul class="leaflet-draw-actions"></ul>
                            </div>
                    ...
                    <p class="bcn-bmap__hint" id="bd-hint">
                      Use the polygon or rectangle tool on the map to trace the site outline, then
                      the edit tool to move a vertex. A boundary is a closed shape — points and
                      lines are off.
                    </p>
                    <div class="bcn-bmap__upload" id="bd-upload" hidden="">
                      <esa-file-upload
                      ...
                      <p class="bcn-bmap__hint">
                        Shapefile (.zip), GeoJSON, or KML/KMZ. Prototype: the file is not parsed —
                        selecting one loads the demo boundary so the rest of the step can be
                        reviewed.
                      </p>
                    </div>
                  </div>
                </div>
                <script type="application/json" data-bcn-bmap-data="bd">
                  {
                    "seedRing": [
                      [35.046419199999995, -118.18244],
                      [35.046419199999995, -118.16956],
                      [35.0569808, -118.16956],
                      [35.0569808, -118.18244]
                    ]
                  }
                </script>
                <script
