            ...
            >
              ...
              <div class="bcn-settings-shell__content" data-esa-surface="">
                <div class="grid" data-gap="lg" style="--grid-min: 22rem">
                        ...
                        <div class="cluster" data-gap="sm">
                          <span
                            ...
                            ><a
                              ...
                              <span class="esa-button__label"> Open guided run </span></a
                            ></span
                          >
                        </div>
                      </div>
                  ...
                  <script
                    type="module"
                    src="/beacon-design/_astro/BcnOpCard.astro_astro_type_script_index_0_lang.DyzF6ftS.js"
                  ></script>
                  <article
                    class="bcn-op"
                    data-op-card=""
                          ...
                          <script type="module">
                            document.addEventListener("click", (o) => {
                              ...
                              const s = Array.from(
                                ...
                                ).filter((e) => !t.contains(e) && e.offsetParent !== null),
                                r =
                                  s.find(
                                    (e) =>
