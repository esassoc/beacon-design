                ...
                <div class="grid" data-gap="lg" style="--grid-min: 22rem">
                    ...
                    <div class="esa-card esa-card--outlined">
                      ...
                      <div class="esa-card__body typography-body-md">
                        <div class="stack" data-gap="sm">
                          <p class="bcn-op__desc typography-body-sm">
                  ...
                  >
                    ...
                    <esa-dialog
                      ...
                      size="md"
                      ><div class="stack" data-gap="sm">
                        <p class="bcn-op__dialog-desc typography-body-md">
                          Re-runs text extraction across this tenant’s source documents so
                          commitment text and page references are rebuilt from the current PDFs.
                        </p>
                        <p class="bcn-op__scope-line typography-body-md">
                          ...
                          <script type="module">
                            document.addEventListener(`click`, (e) => {
                              ...
                              let r = Array.from(
                                ...
                                ).filter((e) => !n.contains(e) && e.offsetParent !== null),
                                i =
                                  r.find(
                                    (e) =>
