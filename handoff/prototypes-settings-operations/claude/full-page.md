...
`beacon` theme of the **prototypes-settings-operations** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/settings/operations/
- **Section element:** `<page>`
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-icon (hub), esa-icon-button (hub), esa-loading-spinner (hub)
          ...
          <section class="page-layout__breadcrumbs">
            <nav class="breadcrumbs" aria-label="Breadcrumb">
              <div class="breadcrumbs__items">
                ...
                <span class="breadcrumb-item" aria-current="page"> Operations </span>
              </div>
            </nav>
          </section>
          <section class="page-layout__title">
            <div class="page-layout__title-main"><h1>Operations</h1></div>
          </section>
                ...
                <div class="stack" data-gap="xl">
                  <div class="grid" data-gap="lg" style="--grid-min: 22rem">
                    <article
                      class="bcn-op"
                      data-op-card=""
                      data-op-id="bulk-eoc-ingest"
                      data-op-name="Bulk EOC Ingest"
                      data-op-scope="tenant"
                      data-ops-wired="1"
                    >
                        ...
                        <div class="esa-card__header">
                          <div class="esa-card__header-content">
                            <div class="esa-card__titles">
                              <h3 class="esa-card__title">Bulk EOC Ingest</h3>
                            </div>
                          </div>
                        </div>
                        <div class="esa-card__body">
                          <div class="stack" data-gap="sm">
                            <p class="bcn-op__desc type-body-small">
                              Matches a folder of field files to action implementations by filename
                              and creates an evidence-of-compliance record for each match. Runs
                              against this tenant.
                            </p>
                          </div>
                        </div>
                          ...
                          <div class="cluster" data-gap="sm">
                            ...
                            >
                              <a class="esa-button__native" href="#" role="button">
                                ...
                                <span class="esa-button__label"> Open guided run </span>
                              </a>
                            </span>
                          </div>
                        </div>
                    ...
                    <script
                      type="module"
                      src="/beacon-design/_astro/BcnOpCard.astro_astro_type_script_index_0_lang.BwjcKYNm.js"
                    ></script>
                    <article
                      class="bcn-op"
                      data-op-card=""
                      data-op-id="extract-source-pdfs"
                      data-op-name="Extract Source PDFs"
                      data-op-scope="tenant"
                      data-ops-wired="1"
                    >
                      <div class="esa-card esa-card--outlined">
                        <div class="esa-card__header">
                          <div class="esa-card__header-content">
                            <div class="esa-card__titles">
                              <h3 class="esa-card__title">Extract Source PDFs</h3>
                            </div>
                          </div>
                        </div>
                        <div class="esa-card__body">
                          <div class="stack" data-gap="sm">
                            <p class="bcn-op__desc type-body-small">
                              Re-runs text extraction across this tenant’s source documents so
                              commitment text and page references are rebuilt from the current PDFs.
                            </p>
                          </div>
                        </div>
                        <div class="esa-card__footer">
                          <div class="cluster" data-gap="sm">
                            ...
                            >
                              <button
                                ...
                                type="button"
                                data-op-run="extract-source-pdfs"
                              >
                                <span class="esa-button__label"> Run… </span>
                              </button>
                            </span>
                          </div>
                        </div>
                      ...
                      <esa-dialog
                        data-op-dialog="extract-source-pdfs"
                        heading="Run Extract Source PDFs?"
                        size="md"
                      >
                        <div class="stack" data-gap="sm">
                          <p class="bcn-op__dialog-desc type-body">
                            Re-runs text extraction across this tenant’s source documents so
                            commitment text and page references are rebuilt from the current PDFs.
                          </p>
                          <p class="bcn-op__scope-line type-body">Runs for this tenant only.</p>
                        </div>
                        <div
                          class="cluster"
                          data-gap="sm"
                        ...
                        >
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-cancel="extract-source-pdfs"
                            >
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-confirm="extract-source-pdfs"
                            >
                              <span class="esa-button__label"> Run now </span>
                            </button>
                          </span>
                        </div>
                      </esa-dialog>
                    ...
                    <article
                      class="bcn-op"
                      data-op-card=""
                      data-op-id="backfill-dmr-eoc"
                      data-op-name="Backfill DMR Evidence"
                      data-op-scope="tenant"
                      data-ops-wired="1"
                    >
                      <div class="esa-card esa-card--outlined">
                        <div class="esa-card__header">
                          <div class="esa-card__header-content">
                            <div class="esa-card__titles">
                              <h3 class="esa-card__title">Backfill DMR Evidence</h3>
                            </div>
                          </div>
                        </div>
                        <div class="esa-card__body">
                          <div class="stack" data-gap="sm">
                            <p class="bcn-op__desc type-body-small">
                              Creates evidence-of-compliance records from this tenant’s historical
                              daily monitoring report data.
                            </p>
                          </div>
                        </div>
                        <div class="esa-card__footer">
                      ...
                      <esa-dialog
                        data-op-dialog="backfill-dmr-eoc"
                        heading="Run Backfill DMR Evidence?"
                        size="md"
                      >
                        <div class="stack" data-gap="sm">
                          <p class="bcn-op__dialog-desc type-body">
                        ...
                        >
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-cancel="backfill-dmr-eoc"
                            >
                              <span class="esa-button__label"> Cancel </span>
                            </button>
                          </span>
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-confirm="backfill-dmr-eoc"
                            >
                              <span class="esa-button__label"> Run now </span>
                            </button>
                          </span>
                    ...
                    <article
                      class="bcn-op"
                      data-op-card=""
                      data-op-id="extend-rolling-window"
                      data-op-name="Extend Rolling Window"
                      data-op-scope="all-tenants"
                      data-ops-wired="1"
                    >
                      <div class="esa-card esa-card--outlined">
                        <div class="esa-card__header">
                          <div class="esa-card__header-content">
                            <div class="esa-card__titles">
                              <h3 class="esa-card__title">Extend Rolling Window</h3>
                            </div>
                          </div>
                        </div>
                        <div class="esa-card__body">
                          <div class="stack" data-gap="sm">
                            <p class="bcn-op__desc type-body-small">
                              Advances the recurring-action scheduling window, generating the next
                              set of due dates for every tenant on the platform.
                            </p>
                          ...
                          <div class="cluster" data-gap="sm">
                            ...
                            >
                              <button
                                class="esa-button__native"
                                type="button"
                                data-op-run="extend-rolling-window"
                              >
                                <span class="esa-button__label"> Run… </span>
                              </button>
                            </span>
                      ...
                      <esa-dialog
                        data-op-dialog="extend-rolling-window"
                        heading="Run Extend Rolling Window?"
                        size="md"
                      >
                        <div class="stack" data-gap="sm">
                          <p class="bcn-op__dialog-desc type-body">
                            Advances the recurring-action scheduling window, generating the next set
                            of due dates for every tenant on the platform.
                          </p>
                          <div class="esa-alert-box esa-alert-box--warning">
                            <div class="esa-alert-box__icon">
                              <svg
                          ...
                          <esa-text-field
                            ...
                            placeholder="Extend Rolling Window"
                            data-op-confirm-input="true"
                            size="md"
                          ></esa-text-field>
                        </div>
                        <div
                        ...
                        >
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-cancel="extend-rolling-window"
                            >
                              <span class="esa-button__label"> Cancel </span>
                            </button>
                          </span>
                          <span
                            class="esa-button esa-button--color-primary esa-button--appearance-fill esa-button--sm esa-button--disabled"
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              disabled=""
                              data-op-confirm="extend-rolling-window"
                            >
                              <span class="esa-button__label"> Run now </span>
                            </button>
                          </span>
                    ...
                    <article
                      class="bcn-op"
                      data-op-card=""
                      data-op-id="send-notifications"
                      data-op-name="Send Notifications"
                      data-op-scope="all-tenants"
                      data-ops-wired="1"
                    >
                      <div class="esa-card esa-card--outlined">
                        <div class="esa-card__header">
                          <div class="esa-card__header-content">
                            <div class="esa-card__titles">
                              <h3 class="esa-card__title">Send Notifications</h3>
                            </div>
                          </div>
                        </div>
                        <div class="esa-card__body">
                          <div class="stack" data-gap="sm">
                            <p class="bcn-op__desc type-body-small">
                              Runs the notification job immediately rather than waiting for the
                              nightly schedule, for every tenant on the platform.
                            </p>
                            <div class="esa-alert-box esa-alert-box--warning">
                              <div class="esa-alert-box__icon">
                                <svg
                          ...
                          <div class="cluster" data-gap="sm">
                            ...
                            >
                              <button
                                class="esa-button__native"
                                type="button"
                                data-op-run="send-notifications"
                              >
                                <span class="esa-button__label"> Run… </span>
                              </button>
                            </span>
                      ...
                      <esa-dialog
                        data-op-dialog="send-notifications"
                        heading="Run Send Notifications?"
                        size="md"
                      >
                        <div class="stack" data-gap="sm">
                          <p class="bcn-op__dialog-desc type-body">
                        ...
                        >
                          ...
                          >
                            <button
                              class="esa-button__native"
                              type="button"
                              data-op-cancel="send-notifications"
                            >
                              <span class="esa-button__label"> Cancel </span>
                            </button>
                          </span>
                          ...
                          >
                            <button
                              ...
                              type="button"
                              disabled=""
                              data-op-confirm="send-notifications"
                            >
                              <span class="esa-button__label"> Run now </span>
                            </button>
                          </span>
                  ...
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__header">
                      <div class="esa-card__header-content">
                        <div class="esa-card__titles">
                          <h3 class="esa-card__title">Run history</h3>
                        </div>
                      </div>
                    </div>
                    <div class="esa-card__body">
                      <section class="bcn-run-history" data-run-history="">
                        <script type="application/json" data-run-history-data="">
                          [
                            {
                              "started": "Jul 29, 8:12 AM",
                              "startedAt": "2026-07-29 08:12",
                              "operation": "Extract Source PDFs",
                              "scope": "This tenant",
                              "scopeTone": "tenant",
                              "actor": "Nadia Boutros",
                              "status": "Running",
                              "statusTone": "running",
                              "result": "341 of 512 documents processed"
                            },
                            {
                              "started": "Jul 27, 2:05 PM",
                              "startedAt": "2026-07-27 14:05",
                              "operation": "Bulk EOC Ingest",
                              "scope": "This tenant",
                              "scopeTone": "tenant",
                              "actor": "Curtis Lam",
                              "status": "Succeeded",
                              "statusTone": "succeeded",
                              "result": "182 files — 174 created, 6 updated, 2 skipped"
                            },
                            {
                              "started": "Jul 24, 11:30 AM",
                              "startedAt": "2026-07-24 11:30",
                              "operation": "Backfill DMR Evidence",
                              "scope": "This tenant",
                              "scopeTone": "tenant",
                              "actor": "Sylvia Marchetti",
                              "status": "Failed",
                              "statusTone": "failed",
                              "result": "Stopped at 41/300 — duplicate DMR keys"
                            },
                            {
                              "started": "Jul 22, 6:00 AM",
                              "startedAt": "2026-07-22 06:00",
                              "operation": "Send Notifications",
                              "scope": "All tenants",
                              "scopeTone": "all-tenants",
                              "actor": "Rob Kittredge",
                              "status": "Succeeded",
                              "statusTone": "succeeded",
                              "result": "214 emails across 9 tenants"
                            },
                            {
                              "started": "Jul 16, 9:48 AM",
                              "startedAt": "2026-07-16 09:48",
                              "operation": "Extract Source PDFs",
                              "scope": "This tenant",
                              "scopeTone": "tenant",
                              "actor": "Nadia Boutros",
                              "status": "Succeeded",
                              "statusTone": "succeeded",
                              "result": "512 documents — 512 extracted, 0 failed"
                            },
                            {
                              "started": "Jul 1, 5:00 AM",
                              "startedAt": "2026-07-01 05:00",
                              "operation": "Extend Rolling Window",
                              "scope": "All tenants",
                              "scopeTone": "all-tenants",
                              "actor": "Rob Kittredge",
                              "status": "Succeeded",
                              "statusTone": "succeeded",
                              "result": "Window advanced to 2027-01-31 for 9 tenants"
                            }
                          ]
                        </script>
                        <div class="bcn-run-history__host" data-run-history-host="">
                          <div
                                    ...
                                    <div class="ag-header-viewport" role="rowgroup" tabindex="-1">
                                      ...
                                      >
                                        <div
                                          ...
                                          tabindex="0"
                                          aria-rowindex="1"
                                          style="top: 0px; height: 48px; width: 968px"
                                        >
                                          <div
                                          ...
                                          <div
                                            class="ag-header-cell ag-column-last ag-header-parent-hidden ag-header-cell-sortable ag-header-cell-wrap-text ag-header-cell-auto-height ag-focus-managed"
                                            role="columnheader"
                                            col-id="result"
                                            aria-colindex="6"
                                            tabindex="-1"
                                    ...
                                    >
                                      ...
                                      >
                                        <div
                                          ...
                                          data-ref="eContainer"
                                          role="presentation"
                                          style="width: 968px; height: 316px"
                                        >
                                          <div
                                            role="row"
                                            comp-id="57"
                                          ...
                                          >
                                            ...
                                            <div
                                              ...
                                              comp-id="59"
                                              col-id="operation"
                                              class="ag-cell-value ag-cell ag-cell-not-inline-editing ag-cell-normal-height bcn-run-history__lead"
                                              tabindex="-1"
                                              aria-colindex="2"
                                              style="left: 140px; width: 180px"
                                            >
                                              Extract Source PDFs
                                            </div>
                                            <div
                                              ...
                                              tabindex="-1"
                                              aria-colindex="3"
                                              style="left: 320px; width: 128px"
                                            >
                                              <span class="bcn-grid-quiet-chip" data-tone="tenant"
                                                >This tenant</span
                                              >
                                            </div>
                                            <div
                                            ...
                                            <div
                                              ...
                                              tabindex="-1"
                                              aria-colindex="5"
                                              style="left: 588px; width: 140px"
                                            >
                                              <span class="bcn-grid-quiet-chip" data-tone="running"
                                                ><span
                                                  class="esa-loading-spinner esa-loading-spinner--xs"
                                                  style="--_spinner-color: currentColor"
                                                >
                                                  <span
                                          ...
                                          <div
                                            ...
                                            aria-rowindex="3"
                                            row-id="1"
                                            style="transform: translateY(44px); height: 57px"
                                          >
                                            <div
                                              role="gridcell"
                                              comp-id="65"
                                            ...
                                            >
                                              <div class="ag-cell-wrapper" role="presentation">
                                                <span class="ag-cell-value" role="presentation"
                                                  >182 files — 174 created, 6 updated, 2
                                                  skipped</span
                                                >
                                              </div>
                                            </div>
                                          ...
                                          <div
                                            ...
                                            aria-rowindex="4"
                                            row-id="2"
                                            style="transform: translateY(101px); height: 57px"
                                          >
                                            <div
                                              role="gridcell"
                                              comp-id="72"
                                            ...
                                            <div
                                              ...
                                              style="left: 588px; width: 140px"
                                            >
                                              <span class="bcn-grid-quiet-chip" data-tone="failed"
                                                >Failed</span
                                              >
                                            </div>
                                            <div
                                            ...
                                            >
                                              <div class="ag-cell-wrapper" role="presentation">
                                                <span class="ag-cell-value" role="presentation"
                                                  >Stopped at 41/300 — duplicate DMR keys</span
                                                >
                                              </div>
                                            </div>
                                          </div>
                                          <div
                                            ...
                                            aria-rowindex="5"
                                            row-id="3"
                                            style="transform: translateY(158px); height: 44px"
                                          >
                                            <div
                                              role="gridcell"
                                              comp-id="79"
                                            ...
                                            >
                                              <div class="ag-cell-wrapper" role="presentation">
                                                <span class="ag-cell-value" role="presentation"
                                                  >214 emails across 9 tenants</span
                                                >
                                              </div>
                                            </div>
                                          </div>
                                          <div
                                            ...
                                            aria-rowindex="6"
                                            row-id="4"
                                            style="transform: translateY(202px); height: 57px"
                                          >
                                            <div
                                              role="gridcell"
                                              comp-id="86"
                                            ...
                                            >
                                              <div class="ag-cell-wrapper" role="presentation">
                                                <span class="ag-cell-value" role="presentation"
                                                  >512 documents — 512 extracted, 0 failed</span
                                                >
                                              </div>
                                            </div>
                                          </div>
                                          <div
                                            ...
                                            aria-rowindex="7"
                                            row-id="5"
                                            style="transform: translateY(259px); height: 57px"
                                          >
                                            <div
                                              role="gridcell"
                                              comp-id="93"
                                            ...
                                            >
                                              <div class="ag-cell-wrapper" role="presentation">
                                                <span class="ag-cell-value" role="presentation"
                                                  >Window advanced to 2027-01-31 for 9 tenants</span
                                                >
                                              </div>
                                            </div>
                                          </div>
                        ...
                        <template data-run-spinner=""
                          ><span
                            class="esa-loading-spinner esa-loading-spinner--xs"
                            style="--_spinner-color: currentColor"
                            data-astro-cid-5fxub4p4=""
                          >
                            <span
                              class="esa-loading-spinner__ring"
                              role="status"
                        ...
                        <template data-run-empty="">
                          <div
                            class="esa-empty-state esa-empty-state--sm"
                            data-astro-cid-cj2rsjdm=""
                          >
                            <h3 class="esa-empty-state__title" data-astro-cid-cj2rsjdm="">
                              No runs yet
                            </h3>
                            <p class="esa-empty-state__description" data-astro-cid-cj2rsjdm="">
                              Operations you run from this console appear here.
                            </p>
                            <div class="esa-empty-state__actions" data-astro-cid-cj2rsjdm=""></div>
                          </div>
                        </template>
                      </section>
                      <script
                        type="module"
                        src="/beacon-design/_astro/BcnRunHistory.astro_astro_type_script_index_0_lang.Dx6R3aqg.js"
                      ></script>
                    </div>
                  </div>
                </div>
...
[data-theme="beacon"] {
  ...
  --alert-box-bg: #f4faff;
  --alert-box-border-color: #acd8fc;
  --alert-box-padding: .75rem 1rem;
  --alert-box-radius: .5rem;
  --alert-box-text-color: #525252;
  --alert-box-title-color: #3d3d3d;
  --bcn-aldo: #08908b;
  --bcn-aldo-100: #cfeceb;
  --bcn-aldo-50: #e8f6f5;
  --bcn-gray-100: #efefef;
  ...
  --color-danger: #e5484d;
  --color-info-border: #acd8fc;
  --color-info-strong: #0d74ce;
  --color-info-subtle: #f4faff;
  ...
  --color-warning-strong: #ab6400;
  --color-warning-subtle: #fefbe9;
  --dialog-bg: #fcfcfc;
  ...
  --loading-spinner-color: #005862;
  --loading-spinner-track-color: #efefef;
  --popover-bg: #fcfcfc;
...
:where(.ag-theme-params-1) {
	...
	--ag-header-background-color: var(--ag-inherited-header-background-color, #ffffff);
	...
	--ag-header-column-resize-handle-color: var(--ag-inherited-header-column-resize-handle-color, #dcdcdc);
	...
	--ag-header-row-border: var(--ag-inherited-header-row-border, 1px solid #dcdcdc);
	--ag-header-text-color: var(--ag-inherited-header-text-color, #3d3d3d);
...
.bcn-op{display:block;--card-footer-bg: transparent}
.bcn-op__desc{line-height:1.4;color:var(--color-text-secondary)}
.bcn-op esa-dialog{--z-modal: 1300;--z-modal-backdrop: 1250}
.bcn-op__dialog-desc{color:var(--color-text-secondary)}
.bcn-op__scope-line{color:var(--color-text-tertiary)}
...
.bcn-op .esa-alert-box__icon svg{display:block}
.esa-alert-box__body{flex:1;min-width:0}
.esa-alert-box__message{color:var(--_alert-text-color)}
.bcn-run-history{inline-size:100%}
.bcn-run-history .bcn-run-history__lead{font-weight:var(--font-weight-medium)}
.bcn-run-history .ag-cell-wrap-text{line-height:1.5;padding-block:var(--spacing-200)}
.bcn-run-history .bcn-grid-quiet-chip{display:inline-flex;align-items:center;gap:var(--spacing-150);padding:1px var(--spacing-200);font-size:.8125rem;line-height:1.6;font-weight:var(--font-weight-medium);color:var(--color-text-secondary);background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-100);white-space:nowrap}
.esa-loading-spinner{--_spinner-size: 32px;--_spinner-border-width: 3px;--_spinner-color: var(--loading-spinner-color, var(--color-primary, #43608a));display:inline-flex;align-items:center;justify-content:center}
.esa-loading-spinner--xs{--_spinner-size: 14px;--_spinner-border-width: 2px}
.esa-loading-spinner__ring{width:var(--_spinner-size);height:var(--_spinner-size);border:var(--_spinner-border-width) solid var(--loading-spinner-track-color, var(--color-border-light, #efefef));border-top-color:var(--_spinner-color);border-radius:var(--radius-full, 9999px);animation:esa-spinner-rotate .75s linear infinite;box-sizing:border-box}
.bcn-run-history .bcn-grid-quiet-chip[data-tone=succeeded]{color:color-mix(in srgb,var(--color-success) 78%,black);background:color-mix(in srgb,var(--color-success) 10%,var(--color-surface));border-color:color-mix(in srgb,var(--color-success) 38%,var(--color-surface))}
.bcn-run-history .bcn-grid-quiet-chip[data-tone=failed]{color:color-mix(in srgb,var(--color-danger) 72%,black);background:color-mix(in srgb,var(--color-danger) 10%,var(--color-surface));border-color:color-mix(in srgb,var(--color-danger) 38%,var(--color-surface))}
.bcn-run-history .bcn-grid-quiet-chip[data-tone=all-tenants]{color:color-mix(in srgb,var(--color-warning) 62%,black);background:color-mix(in srgb,var(--color-warning) 10%,var(--color-surface));border-color:color-mix(in srgb,var(--color-warning) 38%,var(--color-surface))}
...
.bcn-settings-shell__rail{align-self:start}
.bcn-settings-search,.bcn-settings-search__fieldwrap{position:relative}
.bcn-settings-search__icon{position:absolute;inset-inline-start:var(--spacing-250);inset-block-start:50%;transform:translateY(-50%);display:inline-flex;z-index:1;color:var(--color-text-tertiary);pointer-events:none}
.bcn-settings-search__field{--form-padding-x-md: 2rem;--form-border-color-focus: var(--color-text-link);--focus-ring-color: var(--color-text-link);display:block}
.bcn-settings-search__panel{position:absolute;inset-block-start:calc(100% + var(--spacing-100));inset-inline:0;z-index:30;display:flex;flex-direction:column;max-block-size:min(24rem,60vh);overflow-y:auto;background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-100);box-shadow:var(--shadow-300)}
.bcn-settings-search__panel[hidden]{display:none}
.bcn-settings-nav{display:flex;flex-direction:column;gap:var(--spacing-500, 1.5rem)}
.bcn-settings-nav__block{display:flex;flex-direction:column;gap:var(--spacing-400, 1rem)}
.bcn-settings-nav__block--esa{background:var(--bcn-helpbar-bg);-webkit-backdrop-filter:blur(14px) saturate(1.4);backdrop-filter:blur(14px) saturate(1.4);border:1px solid var(--bcn-helpbar-border);border-radius:var(--radius-300, .5rem);padding:var(--spacing-300, .75rem)}
.bcn-settings-nav__aud{display:flex;align-items:center;gap:var(--spacing-200, .5rem);margin:0;padding-inline:var(--spacing-300, .75rem);padding-block-end:var(--spacing-200, .5rem);border-block-end:1px solid var(--color-border-light, var(--color-border));font-weight:var(--font-weight-semibold, 600);color:var(--color-text-primary)}
.bcn-settings-nav__block--esa .bcn-settings-nav__aud{color:#fff}
.bcn-settings-nav__block--esa .bcn-settings-nav__aud{border-block-end-color:color-mix(in srgb,#ffffff 18%,transparent)}
.bcn-settings-nav__aud-icon{display:inline-flex;flex:none}
.bcn-settings-nav__zone{margin:0 0 var(--spacing-100, .25rem);padding-inline:var(--spacing-300, .75rem);text-transform:uppercase;letter-spacing:.06em;font-weight:var(--font-weight-bold, 700);color:var(--color-text-tertiary)}
.bcn-settings-nav__block--esa .bcn-settings-nav__zone{color:color-mix(in srgb,#ffffff 78%,transparent)}
.bcn-settings-nav__list{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:1px}
.bcn-settings-nav__link{display:flex;align-items:center;justify-content:space-between;gap:var(--spacing-200, .5rem);font-size:.8125rem;padding:var(--spacing-150, .375rem) var(--spacing-300, .75rem);border-radius:var(--radius-200, .5rem);color:var(--color-text-secondary);text-decoration:none;transition:background .1s ease,color .1s ease}
.bcn-settings-nav__block--esa .bcn-settings-nav__link{color:color-mix(in srgb,#ffffff 88%,transparent)}
.bcn-settings-nav__page{min-width:0}
.bcn-settings-nav__count{flex:none;font-size:.6875rem;line-height:1.2;padding:1px 5px;border-radius:var(--radius-100, .25rem);background:var(--color-surface-sunken);color:var(--color-text-secondary);font-variant-numeric:tabular-nums}
.bcn-settings-nav__block--esa .bcn-settings-nav__count{background:color-mix(in srgb,#ffffff 14%,transparent);color:color-mix(in srgb,#ffffff 78%,transparent)}
.bcn-settings-nav__link[aria-current=page]{background:var(--color-surface-sunken);color:var(--color-text-primary)}
.bcn-settings-nav__block--esa .bcn-settings-nav__link[aria-current=page]{background:color-mix(in srgb,#ffffff 18%,transparent);color:#fff}
.bcn-settings-nav__link[aria-current=page] .bcn-settings-nav__count{color:inherit;background:color-mix(in srgb,var(--color-text-primary) 10%,transparent)}
.bcn-settings-nav__block--esa .bcn-settings-nav__link[aria-current=page] .bcn-settings-nav__count{background:color-mix(in srgb,#ffffff 20%,transparent)}
.bcn-settings-nav__block+.bcn-settings-nav__block{margin-block-start:var(--spacing-300, .75rem)}
.bcn-settings-shell__content{min-inline-size:0;--card-bg: #ffffff}
.bcn-settings-shell__content[data-esa-surface] .esa-card{--card-header-bg: var(--bcn-helpbar-bg);--card-header-color: #ffffff;--card-header-border-color: transparent}
...
.nav-subdivider{list-style:none;height:1px;margin:var(--spacing-150) 0 var(--spacing-150) 2.5rem;background:var(--bcn-gray-200)}
...
| `--alert-box-bg` | `#f4faff` | component |
| `--alert-box-border-color` | `#acd8fc` | component |
| `--alert-box-padding` | `.75rem 1rem` | component |
| `--alert-box-radius` | `.5rem` | component |
| `--alert-box-text-color` | `#525252` | component |
| `--alert-box-title-color` | `#3d3d3d` | component |
...
| `--color-info-border` | `#acd8fc` | semantic |
| `--color-info-strong` | `#0d74ce` | semantic |
| `--color-info-subtle` | `#f4faff` | semantic |
...
| `--color-warning-border` | `#f3d673` | semantic |
| `--color-warning-strong` | `#ab6400` | semantic |
| `--color-warning-subtle` | `#fefbe9` | semantic |
...
| `--loading-spinner-color` | `#005862` | component |
| `--loading-spinner-track-color` | `#efefef` | component |
