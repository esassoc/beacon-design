              ...
              <main class="bcn-fdetail__main">
                <div class="bcn-detail">
                  ...
                  <section class="bcn-detail__section">
                    ...
                    <script
                      type="module"
                      src="/beacon-design/_astro/BcnFundingPlan.astro_astro_type_script_index_0_lang.CMhmoNI0.js"
                    ></script>
                  </section>
...
[data-theme="beacon"] {
  ...
  --form-affix-bg: #f0f0f0;
  --form-affix-border-color: #cecece;
  --form-affix-color: #646464;
  ...
  --form-label-font-size: clamp(0.75rem, 0.66rem + 0.44vw, 0.9375rem);
...
| `--form-affix-bg` | `#f0f0f0` | component |
| `--form-affix-border-color` | `#cecece` | component |
| `--form-affix-color` | `#646464` | component |
...
| `--form-label-font-size` | `clamp(.75rem, .66rem + .44vw, .9375rem)` | component |
