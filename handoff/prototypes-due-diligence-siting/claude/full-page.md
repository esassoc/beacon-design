...
`beacon` theme of the **prototypes-due-diligence-siting** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/due-diligence-siting/
  ...
  <div class="modern-layout__body">
        ...
        <button type="button" class="project-switcher__trigger">
          <span class="esa-icon esa-icon--sm" aria-hidden="true"
            ...
            >
              ...
              ></path></svg></span
          ><span class="project-switcher__name">No project selected</span
          ><span class="esa-icon esa-icon--sm" aria-hidden="true"
            ><svg
              width="16"
              height="16"
    ...
    <div class="modern-layout__content">
     ...
     moving where the row sits. Only the POSITION and an end slot changed here. -->
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><span class="breadcrumb-item" aria-current="page">Site Screening</span>
            </div>
          </nav>
        </section>
          ...
          <section class="page-layout__content">
            <div class="stack" data-gap="lg">
                ...
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Candidates screened</span
                      ><span class="typography-heading-lg">5</span
                      ><span class="typography-body-sm">Five acquisition criteria each</span>
                    </div>
                  </div>
                </div>
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Passed all criteria</span
                      ><span
                        class="typography-heading-lg"
                        style="color: var(--color-background-utility-success)"
                        >1</span
                      ><span class="typography-body-sm">Eligible to advance</span>
                    </div>
                  </div>
                </div>
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Advancing to due diligence</span
                      ><span class="typography-heading-lg">Project Almond</span
                      ><span class="typography-body-sm">Kern County · 340 ac</span>
                    </div>
                  </div>
                </div>
              </div>
              <div
                ...
                style="height: 380px"
                role="region"
                aria-label="Observation map — 5 observations plotted by severity"
                ...
                >
                  <div class="leaflet-pane leaflet-tile-pane">
                    <div class="leaflet-layer" style="z-index: 1; opacity: 1">
                      <div
                        ...
                        style="z-index: 18; transform: translate3d(-518px, -270px, 0px) scale(2)"
                      ></div>
                      <div
                        class="leaflet-tile-container leaflet-zoom-animated"
                        style="z-index: 19; transform: translate3d(-518px, -270px, 0px) scale(1)"
                      >
                        <img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/10/24?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(782px, 180px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/10/25?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(782px, 436px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/9/24?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(526px, 180px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/11/24?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(1038px, 180px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/9/25?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(526px, 436px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/11/25?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(1038px, 436px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/8/24?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(270px, 180px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/12/24?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(1294px, 180px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/8/25?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(270px, 436px, 0px);
                            opacity: 1;
                          "
                        /><img
                          alt=""
                          src="https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/6/12/25?access_token=undefined"
                          class="leaflet-tile"
                          style="
                            width: 256px;
                            height: 256px;
                            transform: translate3d(1294px, 436px, 0px);
                            opacity: 1;
                          "
                        />
                      </div>
                  ...
                  <div class="leaflet-pane leaflet-overlay-pane">
                    <svg
                      ...
                      width="1121"
                      height="454"
                      viewBox="-93 -38 1121 454"
                      style="transform: translate3d(-93px, -38px, 0px)"
                    >
                      <g>
                        <path
                          ...
                          fill-opacity="0.9"
                          fill-rule="evenodd"
                          d="M511,253a7,7 0 1,0 14,0 a7,7 0 1,0 -14,0 "
                        ></path>
                        <path
                          class="leaflet-interactive"
                          stroke="#fcfcfc"
                          ...
                          fill-opacity="0.9"
                          fill-rule="evenodd"
                          d="M370,78a7,7 0 1,0 14,0 a7,7 0 1,0 -14,0 "
                        ></path>
                        <path
                          class="leaflet-interactive"
                          stroke="#fcfcfc"
                          ...
                          fill-opacity="0.9"
                          fill-rule="evenodd"
                          d="M465,300a7,7 0 1,0 14,0 a7,7 0 1,0 -14,0 "
                        ></path>
                        <path
                          class="leaflet-interactive"
                          stroke="#fcfcfc"
                          ...
                          fill-opacity="0.9"
                          fill-rule="evenodd"
                          d="M407,151a7,7 0 1,0 14,0 a7,7 0 1,0 -14,0 "
                        ></path>
                        <path
                          class="leaflet-interactive"
                          stroke="#fcfcfc"
                          ...
                          fill-opacity="0.9"
                          fill-rule="evenodd"
                          d="M551,287a7,7 0 1,0 14,0 a7,7 0 1,0 -14,0 "
                        ></path>
                      </g>
                    </svg>
                  </div>
                  ...
                  <div
                    ...
                    style="transform: translate3d(2763.14px, 6423.03px, 0px) scale(32)"
                  ></div>
                </div>
              ...
              <script type="application/json" data-bcn-obsmap-data="stg">
                [
                  {
                    "id": "almond",
                    "lat": 35.0517,
                    "lng": -118.176,
                    "label": "Project Almond — passes all criteria",
                    "hex": "#2e7571"
                  },
                  {
                    "id": "grape",
                    "lat": 38.1341,
                    "lng": -121.2722,
                    "label": "Project Grape — 4/5 criteria",
                    "hex": "#8a9099"
                  },
                  {
                    "id": "strawberry",
                    "lat": 34.1975,
                    "lng": -119.1771,
                    "label": "Project Strawberry — 4/5 criteria",
                    "hex": "#8a9099"
                  },
                  {
                    "id": "tomato",
                    "lat": 36.8558,
                    "lng": -120.4593,
                    "label": "Project Tomato — 4/5 criteria",
                    "hex": "#8a9099"
                  },
                  {
                    "id": "garlic",
                    "lat": 34.4264,
                    "lng": -117.3009,
                    "label": "Project Garlic — 4/5 criteria",
                    "hex": "#8a9099"
                  }
                ]
              </script>
              ...
              <div class="esa-card esa-card--padding-compact">
                  ...
                  <div class="esa-card__actions typography-label-md">
                    <span class="bcn-gchrome__search"
                      ><esa-text-field
                        ...
                        size="sm"
                        data-stg-search="true"
                      ></esa-text-field
                      ><span data-stg-search-clear="true" class="astro-kspn7qo2" hidden=""
                        ><span
                    ...
                    ><span data-stg-clear-filters="true" class="astro-kspn7qo2"
                      ><span
                ...
                <div class="esa-card__body typography-body-md">
                  <div class="stg-grid-host" data-stg-host="">
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <!--AG-GRID-BODY-->
                          <div
                            class="ag-root ag-unselectable ag-layout-normal ag-body-horizontal-content-no-gap ag-delay-render"
                            data-ref="eGridRoot"
                            role="grid"
                            aria-colcount="12"
                            aria-rowcount="6"
                              ...
                              <div class="ag-header-viewport" role="rowgroup" tabindex="-1">
                                ...
                                >
                                  <div
                                    ...
                                    tabindex="0"
                                    aria-rowindex="1"
                                    style="top: 0px; height: 48px; width: 1530px"
                                  >
                                    <div
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  role="rowgroup"
                                  aria-hidden="true"
                                  style="height: 220px; width: 0px; max-width: 0px; min-width: 0px"
                                ></div>
                                <!--AG-ROW-CONTAINER-->
                                <div
                                ...
                                >
                                  <div
                                    ...
                                    data-ref="eContainer"
                                    role="presentation"
                                    style="width: 1530px; height: 220px"
                                  >
                                    <div
                                      role="row"
                                      comp-id="66"
                                    ...
                                    >
                                      ...
                                      <div
                                        ...
                                        tabindex="-1"
                                        aria-colindex="7"
                                        style="left: 920px; width: 90px"
                                      >
                                        <span
                                          ><span class="stg-check" data-pass="true">✓</span></span
                                        >
                                      </div>
                                      <div
                                        role="gridcell"
                                    ...
                                    >
                                      ...
                                      >
                                        <span
                                          ><span class="stg-check" data-pass="false">✗</span></span
                                        >
                                      </div>
                                    </div>
                                    <div
                                    ...
                                    >
                                      ...
                                      <div
                                        ...
                                        style="left: 600px; width: 200px"
                                      >
                                        RC Rural Conservation (residential estate)
                                      </div>
                                      <div
                                        role="gridcell"
                                        comp-id="112"
                ...
                <div class="esa-card__footer typography-meta">
                  <div class="repel bcn-gfoot" data-gap="md">
                    <span data-stg-download="true" class="astro-lujwycoi"
                      ><span
                        class="esa-button esa-button--variant-ghost esa-button--appearance-outline esa-button--sm"
                        ><button class="esa-button__native typography-microcopy-xs" type="button">
                          <span class="esa-icon esa-icon--sm" aria-hidden="true"
                    ...
                    <div class="cluster bcn-gfoot__count" data-gap="md">
                      <span
                        >Total Records:
                        <span data-stg-total="true" class="astro-lujwycoi">5</span></span
                      ><span class="bcn-gfoot__filtered" data-stg-filtered="true" hidden=""></span>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <script type="application/json" id="stg-data">
              [
                {
                  "id": "almond",
      ...
      <esa-side-dialog id="stg-drawer" size="md" style="--_width: 520px" position="right"
        ><div slot="header" class="stack" data-gap="xs">
          <span class="typography-body-sm" id="stg-d-region">—</span
          ><span class="typography-title" id="stg-d-name">—</span>
        </div>
        <div class="stack" data-gap="lg">
          <div class="stack" data-gap="xs">
            <span class="typography-body-sm stg-d-label">Acquisition criteria</span>
            <ul class="stg-checklist" id="stg-d-checklist"></ul>
          </div>
          <div class="stack" data-gap="xs">
            <span class="typography-body-sm stg-d-label">Property facts</span>
            <dl class="stg-kv" id="stg-d-facts"></dl>
          </div>
          <p class="typography-body-sm" id="stg-d-reason" hidden=""></p>
        </div>
        <div slot="footer">
          <span id="stg-d-advance"
            ><span
              ...
              ><button class="esa-button__native typography-microcopy-md" type="button">
                ...
                ><span class="esa-button__label">Advance to Due Diligence</span>
              </button></span
            ></span
          >
        </div></esa-side-dialog
...
.bcn-obsmap{border-radius:var(--radius-200);border:1px solid var(--color-border-default);background:var(--color-background-elevation-sunken);z-index:0;isolation:isolate;width:100%;position:relative;overflow:hidden}
...
.stg-grid-host{block-size:22rem;inline-size:100%}
...
.stg-d-label{color:var(--color-content-default-tertiary)}
.stg-checklist{padding:0;padding-left:var(--spacing-300);gap:var(--spacing-250);flex-direction:column;margin:0;list-style:none;display:flex}
.stg-kv{gap:var(--spacing-150) var(--spacing-300);padding-left:var(--spacing-300);grid-template-columns:auto 1fr;margin:0;display:grid}
.bcn-obsmap .leaflet-interactive{cursor:pointer}
.stg-check{font-weight:var(--typography-font-weight-bold);justify-content:center;align-items:center;display:inline-flex}
.stg-check[data-pass=true]{color:var(--color-background-utility-success)}
.stg-check[data-pass=false]{color:var(--color-content-default-tertiary)}
...
.leaflet-top{top:0}
.leaflet-left{left:0}
.leaflet-control{z-index:800;pointer-events:visiblePainted;pointer-events:auto;position:relative}
.leaflet-control{float:left;clear:both}
.leaflet-bar{border-radius:4px;box-shadow:0 1px 5px #000000a6}
...
.leaflet-control-zoom-in,.leaflet-control-zoom-out{text-indent:1px;font:700 18px Lucida Console,Monaco,monospace}
.leaflet-container a{-webkit-tap-highlight-color:#33b5e566}
.leaflet-container a{color:#0078a8}
.leaflet-bar a{text-align:center;color:#000;background-color:#fff;border-bottom:1px solid #ccc;width:26px;height:26px;line-height:26px;text-decoration:none;display:block}
.leaflet-bar a,.leaflet-control-layers-toggle{background-position:50%;background-repeat:no-repeat;display:block}
.leaflet-touch .leaflet-control-zoom-in,.leaflet-touch .leaflet-control-zoom-out{font-size:22px}
.leaflet-bar a:first-child{border-top-left-radius:4px;border-top-right-radius:4px}
.leaflet-touch .leaflet-bar a{width:30px;height:30px;line-height:30px}
.leaflet-touch .leaflet-bar a:first-child{border-top-left-radius:2px;border-top-right-radius:2px}
.leaflet-bar a:last-child{border-bottom:none;border-bottom-right-radius:4px;border-bottom-left-radius:4px}
.leaflet-touch .leaflet-bar a:last-child{border-bottom-right-radius:2px;border-bottom-left-radius:2px}
.leaflet-right{right:0}
.leaflet-bottom{bottom:0}
.leaflet-control-attribution,.leaflet-control-scale-line{color:#333;padding:0 5px;line-height:1.4}
.leaflet-right .leaflet-control{float:right}
.leaflet-bottom .leaflet-control{margin-bottom:10px}
.leaflet-right .leaflet-control{margin-right:10px}
.leaflet-container .leaflet-control-attribution{background:#fffc;margin:0}
.leaflet-control-attribution a{text-decoration:none}
.leaflet-attribution-flag{width:1em;height:.6669em;vertical-align:baseline!important;display:inline!important}
