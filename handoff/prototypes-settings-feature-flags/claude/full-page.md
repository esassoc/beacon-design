                  ...
                  <div class="stack" data-gap="lg">
                    <div class="esa-card esa-card--outlined">
                      ...
                      <div class="esa-card__body typography-body-md">
                        <p class="bcn-flag-list__desc typography-body-md">
                        ...
                        <ul class="bcn-flag-list">
                          <li>
                            ...
                            >
                              ...
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">
                                Monitoring Dashboard
                              </p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                            ...
                            <script
                              type="module"
                              src="/beacon-design/_astro/BcnFlagRow.astro_astro_type_script_index_0_lang.DX3ywg7x.js"
                            ></script>
                          </li>
                          <li>
                            <div
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Spatial Library</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Reporting</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                    ...
                    <div class="esa-card esa-card--outlined">
                      ...
                      <div class="esa-card__body typography-body-md">
                        <p class="bcn-flag-list__desc typography-body-md">
                          Temporary gates for in-flight work — removed when the feature reaches GA.
                        </p>
                        <ul class="bcn-flag-list">
                          <li>
                            <div
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Tenant AI Usage</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Notifications</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Setup Wizard</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Document Review</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Permit Tracking</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
                          ...
                          <li>
                            ...
                            >
                              ...
                              <p class="bcn-flag-row__meta typography-meta">
                                Remove at GA (2026 R4)
                              </p>
                            </div>
                          </li>
                          <li>
                            ...
                            >
                              <esa-switch-toggle
                                ...
                                label-position="after"
                              ></esa-switch-toggle>
                              <p class="bcn-flag-row__name typography-body-md">Site Clearance</p>
                              <p class="bcn-flag-row__desc typography-body-sm">
