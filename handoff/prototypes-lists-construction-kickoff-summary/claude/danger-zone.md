...
## Done when
- Delete asks for confirmation and states that only the list is removed.
  ...
  <div class="bcn-danger-zone__box">
    <div class="bcn-danger-zone__item">
      <div class="bcn-danger-zone__text">
        <h3 class="bcn-danger-zone__title">Delete this Obligation List</h3>
        <p class="bcn-danger-zone__desc">
          Once you delete this list, it will delete all of its metadata and relationships
          to associated obligations. There is no going back. Please be certain.
        </p>
      </div>
