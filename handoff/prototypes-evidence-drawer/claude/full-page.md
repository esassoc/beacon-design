...
`beacon` theme of the **prototypes-evidence-drawer** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/evidence-drawer/
- **Section element:** `<page>`
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-icon (hub), esa-icon-button (hub), esa-loading-spinner (hub), esa-pill (hub)
        ...
        <div class="page-layout__container">
          ...
          <section class="page-layout__content">
            <div class="stack" data-gap="xl">
              <section
                class="bcn-ev-entries stack"
                data-gap="md"
                aria-labelledby="bcn-ev-entries-title"
              >
                <div class="bcn-ev-entries__intro">
                  <h2 class="type-section-title" id="bcn-ev-entries-title">Four ways in</h2>
                  <p class="type-body bcn-ev-entries__lede">
                    The drawer is the same workspace every time. What changes is what is already on
                    it when it opens. Try each one — then close it and open it from the Attach
                    Evidence of Compliance button in the bottom bar.
                  </p>
                </div>
                <div class="bcn-ev-entries__grid">
                  <!-- 1 · Cold open -->
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__body">
                      <div class="bcn-ev-entry">
                        <h3 class="type-card-title">From anywhere</h3>
                        <p class="type-body-small bcn-ev-entry__blurb">
                          The Attach Evidence of Compliance button in the bottom bar, with no
                          context at all — the "I have a PDF on my desktop" case. Nothing is on the
                          right yet; the component you last worked in is already selected.
                        </p>
                        <div class="bcn-ev-entry__demo bcn-ev-entry__demo--quiet">
                          <p class="type-body-small">
                            The Attach Evidence of Compliance button sits in the floating bar at the
                            bottom of every page, where Search used to be.
                          </p>
                        </div>
                        <div class="bcn-ev-entry__act">
                          <span data-evidence-open="cold">
                            <span
                              class="esa-button esa-button--color-primary esa-button--appearance-fill esa-button--md"
                            >
                              <button class="esa-button__native" type="button">
                                <span class="esa-button__label"> Open the drawer </span>
                              </button>
                            </span>
                          </span>
                        </div>
                  ...
                  <!-- 2 · From a single action -->
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__body">
                      <div class="bcn-ev-entry">
                        <h3 class="type-card-title">From an action</h3>
                        <p class="type-body-small bcn-ev-entry__blurb">
                          Add evidence from an open action opens the same global drawer with that
                          one action already on the right, instead of a drawer inside a dialog.
                        </p>
                        <div class="bcn-ev-entry__demo">
                          <p class="bcn-ev-entry__mocklabel type-caption">An open action</p>
                          <p class="bcn-ev-entry__mocktitle">
                            <span class="bcn-cbadge bcn-cbadge--sm">BIO-4.2</span>
                            <span>Preconstruction Swainson’s hawk nest survey</span>
                          </p>
                          <p class="type-body-small bcn-ev-entry__mockmeta">
                            Recurring · Nesting season 2026
                          </p>
                          <div class="bcn-ev-entry__mockact">
                            <span data-evidence-open="single-action">
                              <span
                                class="esa-button esa-button--color-ghost esa-button--appearance-outline esa-button--sm"
                              >
                                <button class="esa-button__native" type="button">
                                  <span class="esa-button__label"> Add evidence </span>
                                </button>
                              </span>
                            </span>
                          </div>
                  ...
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__body">
                      <div class="bcn-ev-entry">
                        <h3 class="type-card-title">From a bulk update</h3>
                        <p class="type-body-small bcn-ev-entry__blurb">
                          Select several actions in a list and add evidence to all of them at once —
                          the case that replaces today’s modal-on-top-of-a-sidebar flow.
                        </p>
                        <div class="bcn-ev-entry__demo">
                          <p class="bcn-ev-entry__mocklabel type-caption">
                            An action list, four selected
                          </p>
                          <ul class="bcn-ev-entry__rows">
                            <li class="bcn-ev-entry__row">
                              <span class="bcn-ev-entry__check" aria-hidden="true">
                                <svg
                                  viewBox="0 0 24 24"
                                  width="12"
                                  height="12"
                              ...
                              <span class="bcn-ev-entry__rowname"
                          ...
                          <div class="bcn-ev-entry__mockact">
                            <span data-evidence-open="bulk">
                              <span
                                class="esa-button esa-button--color-ghost esa-button--appearance-outline esa-button--sm"
                              >
                                <button class="esa-button__native" type="button">
                                  <span class="esa-button__label"> Add evidence to 4 actions </span>
                                </button>
                              </span>
                            </span>
                          </div>
                  ...
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__body">
                      <div class="bcn-ev-entry">
                        <h3 class="type-card-title">Evidence already in Beacon</h3>
                        <p class="type-body-small bcn-ev-entry__blurb">
                          The same workspace, but the left side picks records that are already in
                          the system rather than uploading anything new.
                        </p>
                        <div class="bcn-ev-entry__demo bcn-ev-entry__demo--quiet">
                          <p class="type-body-small">
                            Andrew raised this as a real need: the evidence table is already long,
                            and it grows every day the monitoring portal runs.
                          </p>
                        </div>
                        <div class="bcn-ev-entry__act">
                          <span data-evidence-open="existing">
                            <span
                              class="esa-button esa-button--color-ghost esa-button--appearance-outline esa-button--md"
                            >
                              <button class="esa-button__native" type="button">
                                <span class="esa-button__label"> Open on existing evidence </span>
                              </button>
                            </span>
                          </span>
                        </div>
              ...
              <section
                class="bcn-ev-notes stack"
                data-gap="md"
                aria-labelledby="bcn-ev-notes-title"
              >
                <div>
                  <h2 class="type-section-title" id="bcn-ev-notes-title">About this prototype</h2>
                  <p class="type-body bcn-ev-notes__lede">
                    Nothing here saves. The drawer is a picture of the feature, built to be argued
                    with.
                  </p>
                </div>
                <div class="bcn-ev-notes__grid">
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__header">
                      <div class="esa-card__header-content">
                        <div class="esa-card__titles">
                          <h3 class="esa-card__title">Where it sits</h3>
                        </div>
                      </div>
                    </div>
                    <div class="esa-card__body">
                      <p class="type-body-small bcn-ev-notes__text">
                        Beacon’s drawers come in from the right and hold temporary work. This one is
                        app-shell furniture, like the nav and the top bar, and it layers above
                        modals so it can cover an open dialog.
                      </p>
                      <ul class="bcn-ev-notes__layers">
                        <li class="bcn-ev-notes__layer">
                          <span class="bcn-ev-notes__layername">App chrome</span>
                          <span class="bcn-ev-notes__layernote">Top bar and side nav</span>
                        </li>
                        <li class="bcn-ev-notes__layer">
                          <span class="bcn-ev-notes__layername">Dialogs</span>
                          <span class="bcn-ev-notes__layernote"
                            >The drawer covers these — that is the point</span
                          >
                        </li>
                        <li class="bcn-ev-notes__layer">
                          <span class="bcn-ev-notes__layername">Guidance drawer</span>
                          <span class="bcn-ev-notes__layernote"
                            >Beacon’s other bottom-bar affordance</span
                          >
                        </li>
                        <li class="bcn-ev-notes__layer" data-here="true">
                          <span class="bcn-ev-notes__layername">Evidence drawer</span>
                          <span class="bcn-ev-notes__layernote"
                            >This one — above everything but toasts</span
                          >
                        </li>
                        <li class="bcn-ev-notes__layer">
                          <span class="bcn-ev-notes__layername">Toasts</span>
                          <span class="bcn-ev-notes__layernote"
                            >The only surface that outranks it</span
                          >
                        </li>
                      </ul>
                      <p class="type-caption bcn-ev-notes__caveat">
                        The hub’s drawer lego only opens from the left or right and has no height
                        control, so the bottom drawer is built here and filed as a request upstream.
                      </p>
                    </div>
                  </div>
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__header">
                      <div class="esa-card__header-content">
                        <div class="esa-card__titles">
                          <h3 class="esa-card__title">Not in this round</h3>
                        </div>
                      </div>
                    </div>
                    <div class="esa-card__body">
                      <ul class="bcn-ev-notes__list">
                        <li class="bcn-ev-notes__item">
                          Triage for surveys and daily monitoring reports, which land as evidence
                          today with nothing connecting them to an action. A backlog in the tens is
                          plausibly its own page rather than a tab in here, so it gets designed on
                          its own terms.
                        </li>
                        <li class="bcn-ev-notes__item">
                          Beacon-generated reports becoming evidence once they are finalized.
                        </li>
                        <li class="bcn-ev-notes__item">
                          Public drop links, so people without a Beacon login can submit files.
                        </li>
                        <li class="bcn-ev-notes__item">
                          A view of what has NO evidence yet — the inverse of what this drawer does,
                          and complicated by conditional actions that need none.
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="esa-card esa-card--outlined">
                    <div class="esa-card__header">
                      <div class="esa-card__header-content">
                        <div class="esa-card__titles">
                          <h3 class="esa-card__title">What to react to</h3>
                        </div>
                      </div>
                    </div>
                    <div class="esa-card__body">
                      <ol class="bcn-ev-notes__list bcn-ev-notes__list--numbered">
                        <li class="bcn-ev-notes__item">
                          Does rising from the bottom read as "this is the whole task now", or just
                          as a differently-shaped dialog?
                        </li>
                        <li class="bcn-ev-notes__item">
                          Is it obvious that the left and right sides are being joined — that you
                          are stamping actions with evidence?
                        </li>
                        <li class="bcn-ev-notes__item">
                          Does a file ever feel like a container? It should not: three files dropped
                          together are one item, and nothing names the wrapper.
                        </li>
                        <li class="bcn-ev-notes__item">
                          Are the suggested rows reviewable — can you tell why each one is there and
                          disagree with it?
                        </li>
                        <li class="bcn-ev-notes__item">
                          Is 90 by 80 the right footprint, or does it want to be bigger?
                        </li>
                      </ol>
                    </div>
                  </div>
                  ...
                  <li class="bcn-ev-attached__row" data-astro-cid-5nz34ayf="">
                    ...
                    <span class="bcn-ev-attached__mark" hidden="" data-astro-cid-5nz34ayf="">
                      <span
                        ...
                        data-astro-cid-amzfmcod=""
                      >
                        <span class="esa-badge__text" data-astro-cid-amzfmcod="">Suggested</span>
                      </span>
                    </span>
...
.bcn-ev-entry__demo--quiet {
  color: var(--color-text-secondary);
}
.bcn-ev-entry__demo--quiet p {
  margin: 0;
}
.bcn-ev-entry__act {
  margin-top: var(--spacing-100);
}
.bcn-ev-entry__mocklabel {
  margin: 0 0 var(--spacing-200);
  color: var(--color-text-tertiary);
}
.bcn-ev-entry__mocktitle {
  display: flex;
  align-items: baseline;
  gap: var(--spacing-200);
  margin: 0;
...
.bcn-ev-entry__mockmeta {
  margin: 2px 0 0;
  color: var(--color-text-secondary);
}
.bcn-ev-entry__mockact {
  margin-top: var(--spacing-300);
}
.bcn-ev-entry__rows {
  list-style: none;
...
.bcn-ev-notes__layername {
  font-size: var(--type-size-150, 0.875rem);
  font-weight: var(--font-weight-semibold);
  color: var(--color-text-primary);
}
.bcn-ev-notes__layernote {
  font-size: var(--type-size-150, 0.875rem);
  color: var(--color-text-secondary);
}
.bcn-ev-notes__layer + .bcn-ev-notes__layer {
  border-top: 1px solid var(--color-border-light);
}
.bcn-ev-notes__layer[data-here] {
  background: var(--color-primary-subtle, var(--color-background));
}
.bcn-ev-notes__caveat {
