...
`beacon` theme of the **prototypes-settings** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/settings/
- **Section element:** `<page>`
- **Components:** esa-badge (hub), esa-card (hub), esa-empty-state (hub), esa-icon (hub), esa-icon-button (hub)
      ...
      <div class="page-layout">
        <div class="page-layout__container">
          <section class="page-layout__breadcrumbs">
            <nav class="breadcrumbs" aria-label="Breadcrumb">
              <div class="breadcrumbs__items">
                ...
                <a class="breadcrumb-item" href="/beacon-design/"> Home </a
                ><span class="esa-icon esa-icon--sm" aria-hidden="true">
                  <svg
                    width="16"
                    height="16"
          ...
          <section class="page-layout__title">
            <div class="page-layout__title-main"><h1>Settings</h1></div>
          </section>
                    ...
                    <div class="esa-card__body">
                      <div style="--empty-state-icon-size-lg: 3rem; --icon-size-xl: 3rem">
                        <div class="esa-empty-state esa-empty-state--lg">
                          ...
                          <h3 class="esa-empty-state__title">Select a settings page</h3>
                          <p class="esa-empty-state__description">
                            Pick a page from the rail, or search across every setting.
                          </p>
                    ...
                    <div class="esa-card__header">
                      <div class="esa-card__header-content">
                        <div class="esa-card__titles">
                          <h3 class="esa-card__title">Recent changes</h3>
                        </div>
                      </div>
                    </div>
                    <div class="esa-card__body">
                      <ol class="bcn-change-log">
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 28, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Turned on Site Clearance in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/feature-flags"
                                  ><strong>Feature Flags</strong></a
                                >
                              </span>
                              <span class="bcn-change-log__by">Nadia Boutros</span>
                            </li>
                          </ul>
                        </li>
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 24, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Set Component to Construction Area / Construction Areas in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/terminology"
                                  ><strong>Terminology</strong></a
                                >
                              </span>
                              <span class="bcn-change-log__by">Marla Quintero</span>
                            </li>
                          </ul>
                        </li>
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 21, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Edited Daily Monitoring Report — Biological, now 9 blocks in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/report-templates"
                                  ><strong>Report Templates</strong></a
                                >
                              </span>
                              <span class="bcn-change-log__by">Devin Oyelaran</span>
                            </li>
                          </ul>
                        </li>
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 17, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Invited alonzo.ferrer@water.ca.gov as Read Only in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/users"
                        ...
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 9, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Added the 72-hour clearance review kind in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/site-clearance"
                                  ><strong>Site Clearance</strong></a
                                >
                              </span>
                              <span class="bcn-change-log__by">Sylvia Marchetti</span>
                            </li>
                          </ul>
                        </li>
                        <li class="bcn-change-log__day">
                          <p class="bcn-change-log__date">Jul 2, 2026</p>
                          <ul class="bcn-change-log__events">
                            <li class="bcn-change-log__event">
                              <span class="bcn-change-log__text">
                                Enabled the Spatial Library module in
                                <a
                                  class="bcn-change-log__target"
                                  href="/beacon-design/prototypes/settings/tenant-profile"
                                  ><strong>Tenant Profile</strong></a
                                >
                              </span>
                              <span class="bcn-change-log__by">Marla Quintero</span>
                            </li>
...
.bcn-change-log__date {
  margin: 0 0 var(--spacing-200);
  font-size: 0.8125rem;
  font-weight: var(--font-weight-semibold);
  color: var(--color-text-primary);
}
.bcn-change-log__events {
  list-style: none;
  margin: 0;
  padding: 0;
  display: flex;
...
.bcn-change-log__event {
  display: flex;
  flex-direction: column;
  gap: 1px;
}
.bcn-change-log__text {
  font-size: 0.875rem;
  line-height: 1.4;
  color: var(--color-text-primary);
}
.bcn-change-log__target {
  color: var(--color-text-link);
  text-decoration: none;
}
.bcn-change-log__by {
...
.bcn-change-log__day:last-child {
