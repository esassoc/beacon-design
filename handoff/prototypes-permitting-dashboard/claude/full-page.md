...
`beacon` theme of the **prototypes-permitting-dashboard** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/permitting-dashboard/
    ...
    <nav class="side-nav" id="side-nav">
      ...
      <div class="main-nav">
        ...
        <div class="nav-section nav-section--active">
          ...
          <ul class="nav-section__items">
            <li class="nav-item">
              <a href="/beacon-design/prototypes/permitting-dashboard" class="nav-sublink active"
                >Permit Dashboard</a
              >
            </li>
            <li class="nav-item">
    ...
    <div class="modern-layout__content">
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><span class="breadcrumb-item" aria-current="page">Permit Dashboard</span>
            </div>
          </nav>
        </section>
     ...
     style block already documents. -->
            ...
            <div class="page-layout__utilities">
              <div>
                <a href="/beacon-design/prototypes/permitting-details"
                  ><span
                    ...
                    ><button class="esa-button__native typography-microcopy-md" type="button">
                      ...
                      ><span class="esa-button__label">View Permit Details</span>
                    </button></span
                  ></a
                >
              </div>
                ...
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Permits outstanding</span
                      ><span class="typography-heading-lg" id="pd-outstanding">10</span
                      ><span class="typography-body-sm">Not yet Approved</span>
                    </div>
                  </div>
                </div>
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Approved</span
                      ><span
                        class="typography-heading-lg"
                        id="pd-approved"
                        style="color: var(--color-background-utility-success)"
                        >1</span
                      ><span class="typography-body-sm">Cleared to date</span>
                    </div>
                  </div>
                </div>
                <div class="esa-card">
                  <div class="esa-card__body typography-body-md">
                    <div class="stack" data-gap="xs">
                      <span class="typography-body-sm">Expected permitting completion</span
                      ><span class="typography-heading-lg" id="pd-completion">Mar 1, 2027</span
                      ><span class="typography-body-sm"
                        >Latest dated permit · as of Aug 25, 2026</span
                      >
                    </div>
                  </div>
                </div>
              ...
              <div class="grid" data-gap="md" style="--grid-min: 22rem">
                  ...
                  <div class="esa-card__header">
                    <div class="esa-card__header-content">
                      <div class="esa-card__titles">
                        ...
                        <p class="esa-card__subtitle typography-body-sm">Due within 45 days</p>
                      </div>
                    </div>
                      ...
                      <a href="/beacon-design/prototypes/permitting-details"
                        ><span
                          ...
                          ><button class="esa-button__native typography-microcopy-xs" type="button">
                            <span class="esa-button__label">View all permits</span>
                          </button></span
                        ></a
                      >
                    </div>
                    ...
                    <div id="pd-attention-body">
                      <ul class="pd-attention">
                        <li>
                          ...
                          <span class="pd-attention__date">Oct 1, 2026</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="esa-card">
                  <div class="esa-card__header">
                    <div class="esa-card__header-content">
                      <div class="esa-card__titles">
                        <h3 class="esa-card__title typography-title-sm-strong">By Status</h3>
                        <p class="esa-card__subtitle typography-body-sm">
                          Every tracked permit, one status each
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="esa-card__body typography-body-md">
                    <ul class="pd-status" id="pd-status-list">
                      <li>
                        <span
                          class="bcn-status-chip"
                          data-status="pending-determination"
                          style="--_chip: var(--st-pending-determination, #8a9099)"
                          ><span class="bcn-status-chip__dot"></span
                          ><span class="bcn-status-chip__label">Pending Determination</span></span
                        ><span class="pd-status__count">2</span>
                      </li>
                      <li>
                        <span
                          class="bcn-status-chip"
                          data-status="not-started"
                          style="--_chip: var(--st-not-started, #8a9099)"
                          ><span class="bcn-status-chip__dot"></span
                          ><span class="bcn-status-chip__label">Not Started</span></span
                        ><span class="pd-status__count">3</span>
                      </li>
                      <li>
                        <span
                          class="bcn-status-chip"
                          data-status="in-preparation"
                          style="--_chip: var(--st-in-preparation, #f9a134)"
                          ><span class="bcn-status-chip__dot"></span
                          ><span class="bcn-status-chip__label">In Preparation</span></span
                        ><span class="pd-status__count">2</span>
                      </li>
                      <li>
                        <span
                          ...
                          style="--_chip: var(--st-submitted, #4a90d9)"
                          ><span class="bcn-status-chip__dot"></span
                      ...
                      <li>
                        <span
                          ...
                          style="--_chip: var(--st-under-review, #7b5ea7)"
                          ><span class="bcn-status-chip__dot"></span
                          ><span class="bcn-status-chip__label">Under Agency Review</span></span
                        ><span class="pd-status__count">1</span>
                      </li>
                      <li>
                        <span
                          class="bcn-status-chip"
                          data-status="approved"
                          style="--_chip: var(--st-approved, #2f9e64)"
                          ><span class="bcn-status-chip__dot"></span
