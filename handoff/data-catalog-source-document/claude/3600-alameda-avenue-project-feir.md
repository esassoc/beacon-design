...
`beacon` theme of the **data-catalog-source-document** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/data-catalog-source-document/
- **Section element:** `<div>`
  ...
  <div class="modern-layout__body">
      ...
      <div class="main-nav">
        <div class="nav-section nav-section--active">
          ...
          <ul class="nav-section__items">
            ...
            <li class="nav-item">
              <a href="#dc-source-documents" class="nav-sublink active"> Source Documents </a>
            </li>
            <li class="nav-item">
    ...
    <div class="modern-layout__content">
      <div class="page-layout">
        <div class="page-layout__container">
          <section class="page-layout__breadcrumbs">
            <nav class="breadcrumbs" aria-label="Breadcrumb">
              <div class="breadcrumbs__items">
                ...
                <a class="breadcrumb-item" href="#data-catalog/source-documents">
                  Source Documents </a
                ><span class="esa-icon esa-icon--sm" aria-hidden="true">
                  <svg
                    width="16"
          ...
          <section class="page-layout__title">
            <div class="page-layout__title-main"><h1>3600 Alameda Avenue Project FEIR</h1></div>
          </section>
          <section class="page-layout__content">
            <div class="bcn-doc">
              <!-- Identity header — title + edit action. -->
              <header class="bcn-doc__head">
                <h1 class="bcn-doc__title">3600 Alameda Avenue Project FEIR</h1>
              ...
              <div class="bcn-doc__body">
                <div class="bcn-doc__main">
                  <section class="bcn-doc__section">
                    ...
                    <p class="bcn-prose">
                      Final Environmental Impact Report for the 3600 Alameda Avenue Project,
                      certified by the City of Oakland. It establishes the mitigation measures and
                      standard conditions of approval that govern demolition, construction, and
                      post-construction operation of the project, and is the source of every
                      commitment and requirement tracked under it.
                    </p>
                  </section>
                  ...
                  <details class="esa-collapsible" open="">
                    ...
                    <div class="esa-collapsible__body">
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Reference Number</span>
                        <span class="bcn-key-value__val">SCH #2023040072</span>
                      </div>
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Date of Latest Amendment</span>
                        <span class="bcn-key-value__val">Feb 20, 2026</span>
                      </div>
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Approving Agency</span>
                        <span class="bcn-key-value__val">City of Oakland — Bureau of Planning</span>
                      </div>
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Agency Contact</span>
                        <span class="bcn-key-value__val">Dana Whitfield, Senior Planner</span>
                      </div>
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Agency Signatory</span>
                        <span class="bcn-key-value__val">M. Reyes, Planning Director</span>
                      </div>
                      <div class="bcn-key-value">
                        <span class="bcn-key-value__key">Agreement Terms</span>
                  ...
                  <details class="esa-collapsible" open="">
                    ...
                    <div class="esa-collapsible__body">
                      <ul class="bcn-lists">
                        ...
                        <li>
                          <a class="bcn-list-link" href="#data-catalog/components">Haul Routes</a>
                        </li>
                      </ul>
                    </div>
                  </details>
                        ...
                        <button class="esa-button__native" type="button">
                          <span class="esa-button__label">
                            <span class="bcn-btn-ico"
                              ...
                              Download Source Coversheet</span
                            >
                          </span>
                        </button>
                      </span>
                  ...
                  <div class="bcn-danger-zone__item">
                    <div class="bcn-danger-zone__text">
                      ...
                      <p class="bcn-danger-zone__desc">
                        Deleting this source document also deletes all files attached to it. This
      ...
      >
        <div class="bcn-form bcn-form--dialog">
          ...
          <div class="bcn-grid-2">
            ...
            <esa-text-field id="d-signatory" label="Agency Signatory" size="md"></esa-text-field>
          </div>
      ...
      <script type="application/json" id="edit-meta">
        {
          "docTitle": "3600 Alameda Avenue Project FEIR",
          "project": "3600 Alameda Avenue Project",
          "latestAmendment": "2026-02-20",
          "referenceNumber": "SCH #2023040072",
          "approvingAgency": "City of Oakland — Bureau of Planning",
          "agencyContact": "Dana Whitfield, Senior Planner",
          "agencySignatory": "M. Reyes, Planning Director",
          "description": "Final Environmental Impact Report for the 3600 Alameda Avenue Project, certified by the City of Oakland. It establishes the mitigation measures and standard conditions of approval that govern demolition, construction, and post-construction operation of the project, and is the source of every commitment and requirement tracked under it."
        }
      </script>
      <script type="application/json" id="doc-files-data">
        ["feir-volume-1.pdf", "feir-volume-2_appendices.pdf", "mmrp_adopted_2026-02.pdf"]
      </script>
    </div>
  </div>
</div>
...
.bcn-doc__rail .esa-collapsible__title {
