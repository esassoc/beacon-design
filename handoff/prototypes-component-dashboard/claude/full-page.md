...
`beacon` theme of the **prototypes-component-dashboard** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/component-dashboard/
- **Section element:** `<page>`
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-icon (hub), esa-icon-button (hub), esa-loading-spinner (hub), esa-pill (hub), esa-progress-bar (hub), esa-stat (hub)
      ...
      <div class="main-nav">
        ...
        <div class="nav-section nav-section--active">
          ...
          <ul class="nav-section__items">
            ...
            <li class="nav-item">
              <a href="#all-components" class="nav-sublink active"> All Components </a>
            </li>
          </ul>
        </div>
        <div class="nav-section nav-section--collapsed">
        ...
        <div class="page-layout__container">
          <section class="page-layout__breadcrumbs">
            <nav class="breadcrumbs" aria-label="Breadcrumb">
              <div class="breadcrumbs__items">
                ...
                <span class="breadcrumb-item" aria-current="page"> Components </span>
              </div>
            </nav>
          </section>
          <section class="page-layout__title">
            <div class="page-layout__title-main"><h1>Components</h1></div>
                ...
                <span id="new-cmp-wrap">
                  ...
                  >
                    <button class="esa-button__native" type="button">
                      ...
                      <span class="esa-button__label"> New component </span>
                    </button>
                  </span>
                </span>
              </div>
          ...
          <section class="page-layout__content">
            <div class="stack" data-gap="lg" data-state-panel="populated">
                ...
                <div class="esa-card">
                  <div class="esa-card__header">
                    ...
                    <div class="esa-card__actions">
                      <span class="bcn-summary__count">7 total</span>
                    </div>
                  </div>
                  <div class="esa-card__body">
                    <div class="bcn-summary__main">
                      ...
                      <div
                        ...
                        role="img"
                        aria-label="2 not started, 3 in progress, 1 on hold, 1 complete"
                      >
                        <span
                          class="bcn-summary__seg"
                          style="--_c: #bdbdbd; width: 28.57142857142857%"
                        ></span
                        ><span
                          class="bcn-summary__seg"
                          style="--_c: #f59e0b; width: 42.857142857142854%"
                        ></span
                        ><span
                          class="bcn-summary__seg"
                          style="--_c: #656565; width: 14.285714285714285%"
                        ></span
                        ><span
                          class="bcn-summary__seg"
                          style="--_c: #22c55e; width: 14.285714285714285%"
                        ></span>
                      </div>
                      <ul class="bcn-summary__legend">
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #bdbdbd"></span> Not started
                          <span class="bcn-summary__legend-count">2</span>
                        </li>
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #f59e0b"></span> In progress
                          <span class="bcn-summary__legend-count">3</span>
                        </li>
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #656565"></span> On hold
                          <span class="bcn-summary__legend-count">1</span>
                        </li>
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #22c55e"></span> Complete
                          <span class="bcn-summary__legend-count">1</span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div class="esa-card__body">
                    <div class="bcn-summary__attention">
                      ...
                      <ul class="bcn-summary__att-list">
                        ...
                        <li class="bcn-summary__att-row">
                          <span class="bcn-summary__att-name">Twin Cities Complex</span>
                          <span class="bcn-summary__att-flag">1 overdue</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <section class="bcn-board" aria-label="All components">
                <div class="bcn-board__bar">
                  <div class="bcn-board__title">
                    <h2>All components</h2>
                    <span class="bcn-board__count">7</span>
                  </div>
                  <span class="bcn-board__sort">Sorted by: needs attention</span>
                </div>
                <div class="bcn-board__grid">
                  <article class="bcn-cmp bcn-cmp--attention" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                            width="20"
                            height="20"
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Southern Forebay &amp; Pumping Plant</span>
                        <span class="bcn-cmp__type">Forebay · Byron Tract</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                          data-status="in-progress"
                          style="--_chip: var(--st-in-progress, #f59e0b)"
                        >
                        ...
                        <button
                          ...
                          type="button"
                          aria-label="Delete Southern Forebay &amp; Pumping Plant"
                          title="Delete Southern Forebay &amp; Pumping Plant"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Regulating forebay and pumping plant at the southern terminus of the
                      conveyance tunnel, feeding Bethany Reservoir.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            ...
                            <span class="bcn-cmp__prog-val"><b>11</b> / 14 met</span>
                          </div>
                          <div
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 79%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            ...
                            <span class="bcn-cmp__prog-val"><b>22</b> / 30 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                            ><span class="esa-icon esa-icon--sm" aria-hidden="true">
                              <svg
                                width="16"
                                height="16"
                          ...
                          <span class="bcn-cmp__metric-body">
                            ...
                            <span class="bcn-cmp__metric-val">
                              6 <span class="bcn-cmp__overdue">3 overdue</span>
                            </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            ...
                            <span class="bcn-cmp__metric-val">7</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            ...
                            <span class="bcn-cmp__metric-val">
                              Jul 2 <span class="bcn-cmp__metric-meta">· 11 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      <a class="bcn-cmp__open" href="#component"
                        >Open component
                        <span class="esa-icon esa-icon--sm" aria-hidden="true">
                          <svg
                            width="16"
                      ...
                      <span class="bcn-cmp__updated">Updated 2 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                      aria-label="Delete Southern Forebay &amp; Pumping Plant"
                    >
                      ...
                      <span class="bcn-cmp__confirm-actions">
                        <button
                          type="button"
                          class="bcn-cmp__confirm-btn bcn-cmp__confirm-btn--cancel"
                        ...
                        <button
                          type="button"
                          class="bcn-cmp__confirm-btn bcn-cmp__confirm-btn--delete"
                  ...
                  <script type="module">
                    document.addEventListener("click", (o) => {
                      const e = o.target,
                        t = e.closest(".bcn-cmp");
                      if (!t) return;
                      const c = e.closest("[data-action]");
                      if (c) {
                        const n = c.dataset.action;
                        n === "cancel-delete"
                          ? t.removeAttribute("data-confirm")
                          : n === "confirm-delete" &&
                            ((t.style.transition = "opacity 180ms ease"),
                            (t.style.opacity = "0"),
                            window.setTimeout(() => t.remove(), 190));
                        return;
                      }
                      e.closest(".esa-icon-button") && t.setAttribute("data-confirm", "true");
                    });
                  </script>
                  <article class="bcn-cmp bcn-cmp--attention" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Intake B — North Delta</span>
                        <span class="bcn-cmp__type">Screened intake · Sacramento River</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Intake B — North Delta"
                          title="Delete Intake B — North Delta"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Two-bay cylindrical-tee screened intake on the Sacramento River near Hood,
                      with fish-screen and sediment facilities.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>8</b> / 12 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 67%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>15</b> / 28 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 54%"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val">
                              9 <span class="bcn-cmp__overdue">2 overdue</span>
                            </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">5</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 28 <span class="bcn-cmp__metric-meta">· 6 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 4 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp bcn-cmp--attention" data-status="on-hold">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Twin Cities Complex</span>
                        <span class="bcn-cmp__type">Tunnel shaft · Staging</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                          data-status="on-hold"
                          style="--_chip: var(--st-on-hold, #656565)"
                        >
                          <span class="bcn-status-chip__dot"></span>
                          <span class="bcn-status-chip__label">On hold</span>
                        </span>
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Twin Cities Complex"
                          title="Delete Twin Cities Complex"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Maintenance shaft and reusable tunnel material staging complex; work paused
                      pending revised haul-route agreement.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>4</b> / 10 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 40%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>7</b> / 18 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 39%"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val">
                              5 <span class="bcn-cmp__overdue">1 overdue</span>
                            </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">3</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 12 <span class="bcn-cmp__metric-meta">· 2 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 3 weeks ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Intake C — North Delta</span>
                        <span class="bcn-cmp__type">Screened intake · Sacramento River</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Intake C — North Delta"
                          title="Delete Intake C — North Delta"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Third North Delta diversion intake, sited downstream of Intake B; screens
                      under fabrication.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>6</b> / 12 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 50%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>10</b> / 26 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 38%"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val"> 12 </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 30 <span class="bcn-cmp__metric-meta">· 8 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 5 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="complete">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Bouldin Island Launch Shaft</span>
                        <span class="bcn-cmp__type">Tunnel launch shaft</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                          data-status="complete"
                          style="--_chip: var(--st-complete, #22c55e)"
                        >
                          <span class="bcn-status-chip__dot"></span>
                          <span class="bcn-status-chip__label">Complete</span>
                        </span>
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Bouldin Island Launch Shaft"
                          title="Delete Bouldin Island Launch Shaft"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Tunnel boring machine launch shaft on Bouldin Island; construction complete,
                      in post-construction monitoring.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>9</b> / 9 met</span>
                          </div>
                          <div
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>20</b> / 20 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--success"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val bcn-cmp__metric-val--muted"
                              >None open</span
                            >
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">4</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jul 1 <span class="bcn-cmp__metric-meta">· 4 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 1 week ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="not-started">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Bethany Reservoir Aqueduct</span>
                        <span class="bcn-cmp__type">Aqueduct · Alameda County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                          data-status="not-started"
                          style="--_chip: var(--st-not-started, #bdbdbd)"
                        >
                          <span class="bcn-status-chip__dot"></span>
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Bethany Reservoir Aqueduct"
                          title="Delete Bethany Reservoir Aqueduct"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Aqueduct connecting the Southern Complex to Bethany Reservoir; requirements
                      imported, field work not yet begun.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 9 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 14 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">2</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 2 weeks ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="not-started">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Byron Tract Forebay</span>
                        <span class="bcn-cmp__type">Forebay · Contra Costa County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Byron Tract Forebay"
                          title="Delete Byron Tract Forebay"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Secondary forebay component; scoping in progress, no active requirements or
                      monitoring yet.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 7 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 11 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">1</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 1 month ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
            ...
            <div data-state-panel="empty" hidden="">
              <div class="esa-empty-state esa-empty-state--lg">
                ...
                <h3 class="esa-empty-state__title">No components yet</h3>
                <p class="esa-empty-state__description">
                  Components are the pieces of Delta Conveyance you track compliance against —
                  intakes, shafts, forebays, staging areas. Add the first one to start rolling up
                  its requirements, actions, and monitoring activity here.
                </p>
                <div class="esa-empty-state__actions">
                  ...
                  >
                    <button class="esa-button__native" type="button">
                      ...
                      <span class="esa-button__label"> Add first component </span>
                    </button>
                  </span>
                  <span
                  ...
                  >
                    <button class="esa-button__native" type="button">
                      <span class="esa-button__label"> Import from source documents </span>
                    </button>
                  </span>
                </div>
              </div>
            ...
            <div class="stack" data-gap="lg" data-state-panel="dense" hidden="">
                ...
                <div class="esa-card">
                  ...
                  <div class="esa-card__body">
                    <div class="bcn-summary__main">
                      ...
                      >
                        <span class="bcn-summary__seg" style="--_c: #bdbdbd; width: 25%"></span
                        ><span class="bcn-summary__seg" style="--_c: #f59e0b; width: 43.75%"></span
                        ><span class="bcn-summary__seg" style="--_c: #656565; width: 12.5%"></span
                        ><span class="bcn-summary__seg" style="--_c: #22c55e; width: 18.75%"></span>
                      </div>
                      <ul class="bcn-summary__legend">
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #bdbdbd"></span> Not started
                          <span class="bcn-summary__legend-count">4</span>
                        </li>
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #f59e0b"></span> In progress
                          <span class="bcn-summary__legend-count">7</span>
                        </li>
                        <li class="bcn-summary__legend-item">
                          <span class="bcn-summary__dot" style="--_c: #656565"></span> On hold
                          <span class="bcn-summary__legend-count">2</span>
              ...
              <section class="bcn-board" aria-label="All components">
                <div class="bcn-board__bar">
                  <div class="bcn-board__title">
                    <h2>All components</h2>
                    <span class="bcn-board__count">16</span>
                  </div>
                  <span class="bcn-board__sort">Sorted by: needs attention</span>
                </div>
                <div class="bcn-board__grid">
                  <article class="bcn-cmp bcn-cmp--attention" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Southern Tunnel Reach — King Island to Bethany Complex Launch Shaft
                          Transition Zone</span
                        >
                        <span class="bcn-cmp__type">Tunnel reach · San Joaquin County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Southern Tunnel Reach — King Island to Bethany Complex Launch Shaft Transition Zone"
                          title="Delete Southern Tunnel Reach — King Island to Bethany Complex Launch Shaft Transition Zone"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Long-bore tunnel reach transitioning from the King Island intermediate shaft
                      to the Bethany Complex launch shaft, crossing multiple leveed islands and
                    ...
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>13</b> / 24 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>31</b> / 58 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 53%"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val">
                              19 <span class="bcn-cmp__overdue">6 overdue</span>
                            </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jul 3 <span class="bcn-cmp__metric-meta">· 22 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 1 day ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp bcn-cmp--attention" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Mandeville Island Tunnel Material Reuse Site</span
                        >
                        <span class="bcn-cmp__type">Reuse site · San Joaquin County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Mandeville Island Tunnel Material Reuse Site"
                          title="Delete Mandeville Island Tunnel Material Reuse Site"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Placement and grading site for reusable tunnel material from the central
                      reaches, with erosion-control monitoring.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>4</b> / 12 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>8</b> / 22 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val">
                              7 <span class="bcn-cmp__overdue">1 overdue</span>
                            </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 27 <span class="bcn-cmp__metric-meta">· 4 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                  ...
                  <article class="bcn-cmp" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Union Island Reusable Tunnel Material Storage &amp; Rehandling Area</span
                        >
                        <span class="bcn-cmp__type">Staging · Reusable tunnel material</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Union Island Reusable Tunnel Material Storage &amp; Rehandling Area"
                          title="Delete Union Island Reusable Tunnel Material Storage &amp; Rehandling Area"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Temporary storage and rehandling area for reusable tunnel material excavated
                      along the southern reaches.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>5</b> / 11 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 45%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>9</b> / 21 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val"> 8 </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">6</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 26 <span class="bcn-cmp__metric-meta">· 5 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 6 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="in-progress">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Lower Roberts Island Maintenance Shaft &amp; Ventilation Structure</span
                        >
                        <span class="bcn-cmp__type">Tunnel shaft · San Joaquin County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Lower Roberts Island Maintenance Shaft &amp; Ventilation Structure"
                          title="Delete Lower Roberts Island Maintenance Shaft &amp; Ventilation Structure"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Permanent maintenance and ventilation shaft on Lower Roberts Island with
                    ...
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>7</b> / 15 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 47%"></div>
                            </div>
                          </div>
                        </div>
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>12</b> / 27 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                          ...
                          >
                            <div class="esa-progress-bar__track">
                              <div class="esa-progress-bar__fill" style="width: 44%"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="bcn-cmp__metrics">
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Open actions</span>
                            <span class="bcn-cmp__metric-val"> 10 </span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 29 <span class="bcn-cmp__metric-meta">· 9 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 3 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="complete">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Rio Vista Field Office &amp; Environmental Staging Yard</span
                        >
                        <span class="bcn-cmp__type">Field office · Solano County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Rio Vista Field Office &amp; Environmental Staging Yard"
                          title="Delete Rio Vista Field Office &amp; Environmental Staging Yard"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Compliance field office and environmental staging yard supporting the northern
                      reaches.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>6</b> / 6 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--success"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>14</b> / 14 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--success"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 20 <span class="bcn-cmp__metric-meta">· 1 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                  ...
                  <article class="bcn-cmp" data-status="on-hold">
                    <div class="bcn-cmp__head">
                      <span class="bcn-cmp__glyph"
                        ><span class="esa-icon esa-icon--md" aria-hidden="true">
                          <svg
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Central Tunnel Reach</span>
                        <span class="bcn-cmp__type">Tunnel reach · Sacramento County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Central Tunnel Reach"
                          title="Delete Central Tunnel Reach"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Central segment of the main conveyance tunnel; geotechnical re-evaluation
                      underway before mobilization.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>3</b> / 18 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>4</b> / 33 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Work areas</span>
                            <span class="bcn-cmp__metric-val">9</span>
                          </span>
                        </div>
                        <div class="bcn-cmp__metric">
                          <span class="bcn-cmp__metric-icon"
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              May 30 <span class="bcn-cmp__metric-meta">· 0 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 5 weeks ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
                  ...
                  <article class="bcn-cmp" data-status="not-started">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">Turner Cut Barge Landing</span>
                        <span class="bcn-cmp__type">Barge landing · Waterway access</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Turner Cut Barge Landing"
                          title="Delete Turner Cut Barge Landing"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Temporary barge landing for waterborne material delivery; permitting in early
                      stage.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 8 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 12 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                  ...
                  <article class="bcn-cmp" data-status="not-started">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name">King Island Intermediate Shaft</span>
                        <span class="bcn-cmp__type">Tunnel shaft · San Joaquin County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete King Island Intermediate Shaft"
                          title="Delete King Island Intermediate Shaft"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Intermediate tunnel shaft supporting the southern reaches; requirements
                      loaded, field work pending.
                    </p>
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 13 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>0</b> / 19 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--primary"
                            role="progressbar"
                  ...
                  <article class="bcn-cmp" data-status="complete">
                    <div class="bcn-cmp__head">
                      ...
                      <div class="bcn-cmp__ident">
                        <span class="bcn-cmp__name"
                          >Bethany Reservoir Complex — Discharge Structure</span
                        >
                        <span class="bcn-cmp__type">Discharge structure · Alameda County</span>
                      </div>
                      <div class="bcn-cmp__head-right">
                        <span
                          class="bcn-status-chip"
                        ...
                        <button
                          class="esa-icon-button esa-icon-button--sm"
                          type="button"
                          aria-label="Delete Bethany Reservoir Complex — Discharge Structure"
                          title="Delete Bethany Reservoir Complex — Discharge Structure"
                        >
                          <span class="esa-icon esa-icon--sm" aria-hidden="true">
                            <svg
                              width="16"
                    ...
                    <p class="bcn-cmp__desc">
                      Terminal discharge structure delivering conveyed water into Bethany Reservoir;
                    ...
                    <div class="bcn-cmp__rollups">
                      <div class="bcn-cmp__prog">
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Requirements</span>
                            <span class="bcn-cmp__prog-val"><b>11</b> / 11 met</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--success"
                            role="progressbar"
                        ...
                        <div class="bcn-cmp__prog-row">
                          <div class="bcn-cmp__prog-head">
                            <span class="bcn-cmp__prog-label">Actions</span>
                            <span class="bcn-cmp__prog-val"><b>26</b> / 26 complete</span>
                          </div>
                          <div
                            class="esa-progress-bar esa-progress-bar--sm esa-progress-bar--success"
                            role="progressbar"
                      ...
                      <div class="bcn-cmp__metrics">
                        ...
                        <div class="bcn-cmp__metric">
                          ...
                          <span class="bcn-cmp__metric-body">
                            <span class="bcn-cmp__metric-label">Recent monitoring</span>
                            <span class="bcn-cmp__metric-val">
                              Jun 24 <span class="bcn-cmp__metric-meta">· 3 in 30d</span>
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="bcn-cmp__foot">
                      ...
                      <span class="bcn-cmp__updated">Updated 10 days ago</span>
                    </div>
                    <div
                      class="bcn-cmp__confirm"
                      role="alertdialog"
           ...
           is already on every action in view can have it withdrawn. -->
                              ...
                              >
                                <span class="bcn-countchip__stack">
                                  ...
                                  <span class="bcn-countchip__num" aria-hidden="true">
                                    <span class="esa-badge esa-badge--primary esa-badge--xs"
                                      >0</span
                                    >
                                  </span>
                  ...
                  <div class="bcn-ev-staging__empty" data-staging-empty="">
                    <div class="esa-empty-state esa-empty-state--sm">
                      <h3 class="esa-empty-state__title">Nothing added yet</h3>
                      <p class="esa-empty-state__description">
       ...
       on; all three are guarded while associations are unsaved (see evidence-drawer.ts). -->
         ...
         hand-written copies of it (the same trick BcnGuidanceDrawer uses for its avatar). -->
                ...
                <div class="bcn-ev-targets__empty" data-targets-empty="">
                  <div class="esa-empty-state esa-empty-state--sm">
                    <h3 class="esa-empty-state__title">No actions selected</h3>
                    <p class="esa-empty-state__description">
              ...
              <div class="bcn-ev-targets__pending" data-targets-pending="" hidden="">
                <div class="esa-alert-box esa-alert-box--warning">
                  ...
                  <div class="esa-alert-box__body">
                    <strong class="esa-alert-box__title">Unsaved changes</strong>
        ...
        <div class="bcn-ev__foot">
          <div class="bcn-ev__actions">
            <span data-evidence-save="">
              <span
                class="esa-button esa-button--color-primary esa-button--appearance-fill esa-button--md esa-button--disabled"
              >
                <button class="esa-button__native" type="button" disabled="">
                  <span class="esa-button__label"> Save </span>
                </button>
              </span>
            </span>
...
[data-theme="beacon"] {
  ...
  --progress-bar-fill-bg: #005862;
  --progress-bar-height-md: 8px;
  --progress-bar-height-sm: 4px;
  --progress-bar-radius: 9999px;
  --progress-bar-track-bg: #efefef;
  --radius-100: 0.25rem;
  --radius-200: 0.5rem;
  --radius-300: 0.5rem;
  --radius-400: 0.75rem;
  ...
  --type-size-050: clamp(0.5rem, 0.44rem + 0.3vw, 0.625rem);
...
.bcn-cmp__head-right .esa-icon-button {
...
.bcn-cmp__metric-icon {
  color: var(--color-text-muted);
  flex-shrink: 0;
  display: inline-flex;
}
.bcn-cmp__metric-body {
  display: flex;
  flex-direction: column;
  min-width: 0;
}
.bcn-cmp__metric-label {
  font-size: var(--type-size-100);
  color: var(--color-text-tertiary);
}
.bcn-cmp__metric-val {
...
| `--color-backdrop` | `rgba(0, 0, 0, .5)` | primitive |
...
| `--progress-bar-fill-bg` | `#005862` | component |
| `--progress-bar-height-md` | `8px` | component |
| `--progress-bar-height-sm` | `4px` | component |
| `--progress-bar-radius` | `9999px` | component |
| `--progress-bar-track-bg` | `#efefef` | component |
