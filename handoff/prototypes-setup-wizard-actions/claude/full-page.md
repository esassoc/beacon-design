...
`beacon` theme of the **prototypes-setup-wizard-actions** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/setup-wizard/actions/
          ...
          <section class="page-layout__content">
            <div class="bcn-swf">
              <header class="bcn-swf__head">
                <a class="bcn-swf__home" href="/beacon-design/prototypes/setup-wizard"
                  ><span class="bcn-swf__mark" aria-hidden="true"
                    ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                      ><svg
                        width="14"
                        height="14"
                      ...
                      >
                        ...
                        <circle cx="12" cy="12" r="10"></circle></svg></span
                  ></span>
                  <h1 class="bcn-swf__title">Setup Wizard</h1></a
                >
                <p class="bcn-swf__sub">
                  From source documents to trackable actions and obligations.
                </p>
              </header>
                ...
                <ol class="bcn-swf__steps">
                  <li class="bcn-swf__item">
                    <a
                      ...
                      ><span class="bcn-swf__label">Source Documents</span
                      ><span class="bcn-swf__check" aria-label="Step complete"
                        ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                          ><svg
                            width="14"
                            height="14"
                  ...
                  <li class="bcn-swf__item">
                    <a
                      ...
                      style="--_step: var(--color-commitment)"
                      ><span class="bcn-swf__icon" aria-hidden="true"
                        ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                          ><svg
                            width="16"
                      ...
                      ><span class="bcn-swf__label">Commitments</span
                      ><span class="bcn-swf__check" aria-label="Step complete"
                        ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                          ><svg
                            width="14"
                  ...
                  <li class="bcn-swf__item">
                    <a
                      ...
                      style="--_step: var(--color-requirement)"
                      ><span class="bcn-swf__icon" aria-hidden="true"
                        ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                          ><svg
                            width="16"
                      ...
                      ><span class="bcn-swf__label">Requirements</span
                      ><span class="bcn-swf__check" aria-label="Step complete"
                        ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                          ><svg
                            width="14"
              ...
              <div class="bcn-swf__body">
                <div class="stack" data-gap="md">
                  <section class="bcn-swsp" style="--_step: var(--color-action)">
                    <header class="bcn-swsp__header">
                      <div class="bcn-swsp__row">
                        <span class="bcn-swsp__num" aria-hidden="true">4</span>
                        <h2 class="bcn-swsp__title">
                          <span>Actions during</span
                          ><button
                            type="button"
                            class="bcn-swsc"
                            aria-label="Phase: Construction"
                            aria-haspopup="menu"
                          >
                            <span class="bcn-swsc__label">Construction</span
                          ...
                          <script
                            type="module"
                            src="/beacon-design/_astro/BcnSwSelectChip.astro_astro_type_script_index_0_lang.LIz09pfn.js"
                          ></script>
                          <span>for</span
                          ><button
                            type="button"
                            class="bcn-swsc"
                            aria-label="Requirement type: Avoidance &amp; BMPs"
                            aria-haspopup="menu"
                          >
                            <span class="bcn-swsc__label">Avoidance &amp; BMPs</span
                            ><span class="bcn-swsc__chevron" aria-hidden="true"
                              ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                                ><svg
                                  width="16"
                          ...
                          ><span
                            class="bcn-swcb"
                            aria-label="280 requirements in this phase and type"
                            >280</span
                          >
                        </h2>
                        <div class="bcn-swsp__actions"></div>
                      </div>
                      <p class="bcn-swsp__intro">
                        Review the actions drafted for this phase and type: approve the ones that
                        are right, edit the ones that are not, and send each requirement still
                        without a home to an obligation or mark it not applicable.
                      </p>
                    </header>
                    <section class="bcn-swai">
                      <button
                        type="button"
                        class="bcn-swai__header"
                        aria-expanded="false"
                        data-swai-toggle=""
                      >
                        <span class="bcn-swai__mark" aria-hidden="true"
                          ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                            ><svg
                              width="14"
                              height="14"
                        ...
                        ><span class="bcn-swai__label">Create Actions with AI</span
                        ><span
                          class="bcn-swai__tag"
                          title="This feature is experimental and subject to change."
                          ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                            ><svg
                              width="14"
                              height="14"
                          ...
                          >Experimental</span
                        ><span
                          class="bcn-swai__chevron bcn-swai__chevron--closed"
                          aria-hidden="true"
                          ><span class="esa-icon esa-icon--md" aria-hidden="true"
                            ><svg
                              width="20"
                        ...
                        ><span class="bcn-swai__chevron bcn-swai__chevron--open" aria-hidden="true"
                          ><span class="esa-icon esa-icon--md" aria-hidden="true"
                            ><svg
                              width="20"
                              height="20"
                      ...
                      <div class="bcn-swai__panel" hidden="">
                        <div class="bcn-swai__body">
                          <div class="bcn-swai__main">
                            <div class="bcn-swai__shell">
                              <textarea
                                class="bcn-swai__textarea"
                                rows="3"
                                maxlength="2000"
                                placeholder="Describe how you'd like to group the remaining requirements (e.g., 'group by work area' or 'one action per BMP')"
                                aria-label="Create Actions with AI"
                              ></textarea>
                              <div class="bcn-swai__input-footer">
                                <div class="bcn-swai__chips">
                                  <span class="bcn-swai__chip"
                                    >Phase: <strong>Construction</strong></span
                                  ><span class="bcn-swai__chip"
                                    >Type: <strong>Avoidance &amp; BMPs</strong></span
                                  ><span class="bcn-swai__chip"
                                    >Requirements: <strong>4</strong></span
                                  >
                                </div>
                                <div class="bcn-swai__footer-actions">
                                  <button type="button" class="bcn-swai__suggest">
                                    <span class="esa-icon esa-icon--sm" aria-hidden="true"
                                      ><svg
                                        width="16"
                                        height="16"
                                    ...
                                    >Suggest a Prompt</button
                                  ><button
                                    type="button"
                                    class="bcn-swai__send"
                          ...
                          <aside class="bcn-swai__sidecar" aria-hidden="true"></aside>
                        </div>
                        <div class="bcn-swai__divider" aria-hidden="true"></div>
                        <div class="bcn-swfr bcn-swfr--inset">
                          <esa-text-field
                            class="bcn-swfr__search"
                            size="sm"
                            name="swai-search"
                            placeholder="Search requirements by name or text..."
                            aria-label="Search requirements by name or text..."
                          ></esa-text-field
                          ><esa-select
                            class="bcn-swfr__picker"
                            size="sm"
                            name="swai-search-species"
                            options='[{"label":"Species","value":""}]'
                            value=""
                            placeholder="Species"
                            cue="Filter by species."
                          ></esa-select
                          ><esa-select
                            class="bcn-swfr__picker"
                            size="sm"
                            name="swai-search-milestones"
                            options='[{"label":"Milestones","value":""}]'
                            value=""
                            placeholder="Milestones"
                            cue="Filter by milestones."
                          ></esa-select
                          ><esa-select
                            class="bcn-swfr__picker"
                            size="sm"
                            name="swai-search-activities"
                            options='[{"label":"Activities","value":""}]'
                            value=""
                            placeholder="Activities"
                            cue="Filter by activities."
                          ></esa-select>
                    ...
                    <script type="module">
                      document.querySelectorAll(`[data-swai-toggle]`).forEach((e) => {
                        e.addEventListener(`click`, () => {
                          let t = e.closest(`.bcn-swai`),
                            n = t.querySelector(`.bcn-swai__panel`),
                            r = t.hasAttribute(`data-expanded`);
                          (t.toggleAttribute(`data-expanded`, !r),
                  ...
                  <div class="bcn-swb">
                    <section
                      class="bcn-swb__col bcn-swb__col--left"
                      aria-label="Unrouted requirements"
                    >
                      <header class="bcn-swb__head">
                        <h2 class="bcn-swb__title">Unrouted requirements</h2>
                        <span class="bcn-swcb" aria-label="4 requirements not yet routed">4</span>
                        <div class="bcn-swb__head-verbs"></div>
                      </header>
                      <div class="bcn-swb__body">
                        <div class="bcn-swrr">
                          <div
                            class="bcn-swrr__main"
                            role="button"
                            tabindex="0"
                            aria-expanded="false"
                            aria-label="Expand Halt Work and Apply Corrective Measures on GGS Discovery"
                          >
                            <span class="bcn-swrr__grip" aria-hidden="true"
                              ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                ><svg
                                  width="20"
                                  height="20"
                                ...
                                >
                                  ...
                                  <circle cx="15" cy="19" r="1"></circle></svg></span></span
                            ><span class="bcn-swrr__chevron" aria-hidden="true"
                              ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                ><svg
                                  width="20"
                                  height="20"
                            ...
                            ><span class="bcn-swrr__name"
                              >Halt Work and Apply Corrective Measures on GGS Discovery</span
                            ><span class="bcn-swrr__verbs"
                              ><span
                                ...
                                ><button
                                  ...
                                  type="button"
                                  title="Route to an obligation instead of an action"
                                >
                                  <span class="esa-button__label">To obligation</span>
                                </button></span
                              ><span
                                class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                                ><button
                                ...
                                >
                                  <span class="esa-button__label">Not applicable</span>
                                </button></span
                              ></span
                            >
                          </div>
                        ...
                        <div class="bcn-swrr">
                          <div
                            ...
                            tabindex="0"
                            aria-expanded="false"
                            aria-label="Expand Restrict Upland Habitat Work to the GGS Active Season"
                          >
                            <span class="bcn-swrr__grip" aria-hidden="true"
                              ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                ><svg
                            ...
                            ><span class="bcn-swrr__name"
                              >Restrict Upland Habitat Work to the GGS Active Season</span
                            ><span class="bcn-swrr__verbs"
                              ><span
                                class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                                ><button
                        ...
                        <div class="bcn-swrr">
                          <div
                            ...
                            tabindex="0"
                            aria-expanded="false"
                            aria-label="Expand Avoid Vegetation/Ground Disturbance During Colony Active Period"
                          >
                            <span class="bcn-swrr__grip" aria-hidden="true"
                              ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                ><svg
                            ...
                            ><span class="bcn-swrr__name"
                              >Avoid Vegetation/Ground Disturbance During Colony Active Period</span
                            ><span class="bcn-swrr__verbs"
                              ><span
                                class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                                ><button
                        ...
                        <div class="bcn-swrr">
                          <div
                            ...
                            tabindex="0"
                            aria-expanded="false"
                            aria-label="Expand Avoid Vegetation/Ground Disturbance During Flight Seasons"
                          >
                            <span class="bcn-swrr__grip" aria-hidden="true"
                              ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                ><svg
                            ...
                            ><span class="bcn-cbadge bcn-cbadge--sm">COA 11.95</span
                            ><span class="bcn-swrr__name"
                              >Avoid Vegetation/Ground Disturbance During Flight Seasons</span
                            ><span class="bcn-swrr__verbs"
                              ><span
                                class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                                ><button
                      ...
                      <footer class="bcn-swb__foot">
                        <span
                          class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                          ><button
                            class="esa-button__native typography-microcopy-2xs"
                            type="button"
                            title="Create one Draft action per unrouted requirement"
                          >
                              ...
                              ><span class="sw-verb"
                                ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                                  ...
                                  >
                                    ...
                                    <path d="M3 10v6c0 1.1.9 2 2 2h3"></path></svg></span
                                >Convert Each (4)</span
                              ></span
                            >
                          </button></span
                        ><span
                          ...
                          ><button
                            class="esa-button__native typography-microcopy-2xs"
                            type="button"
                            title="Combine every unrouted requirement into one Draft action"
                          >
                            <span class="esa-button__label"
                              ><span class="sw-verb"
                                ><span class="sw-verb__rot"
                                  ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                                    ><svg
                                      width="14"
                                      height="14"
                                    ...
                                    >
                                      ...
                                      <path d="m20 22-5-5"></path></svg></span></span
                                >Combine All (4)</span
                              ></span
                            >
                          </button></span
                    ...
                    <section class="bcn-swb__col bcn-swb__col--right" aria-label="Actions">
                      <header class="bcn-swb__head">
                        <h2 class="bcn-swb__title">Actions</h2>
                        <span class="bcn-swcb" aria-label="22 actions">22</span>
                        <div class="bcn-swb__head-verbs">
                          <span
                            class="esa-button esa-button--variant-ghost esa-button--appearance-fill esa-button--xs"
                            ><button
                              class="esa-button__native typography-microcopy-2xs"
                      ...
                      <div class="bcn-swb__body">
                        ...
                        <ul class="sw-action-list">
                          <li class="bcn-swac" data-status="approved">
                            <div
                              class="bcn-swac__main"
                              role="button"
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Delineate habitat, buffers, and construction site boundaries"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                                    width="20"
                                    height="20"
                                  ...
                                  >
                                    <path d="m9 18 6-6-6-6"></path></svg></span></span
                              ><span class="bcn-swac__pill bcn-swac__pill--approved"
                                ><span class="bcn-swac__dot" aria-hidden="true"></span
                                >Approved</span
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                                  >Delineate habitat, buffers, and construction site
                                  boundaries</span
                                ><button
                                  type="button"
                                  class="bcn-swac__edit"
                                  title="Edit action"
                                  aria-label="Edit action"
                                  data-open-dialog="swa-edit"
                                >
                                  <span class="esa-icon esa-icon--sm" aria-hidden="true"
                                    ><svg
                                      width="16"
                                    ...
                                    >
                                      ...
                                      ></path></svg
                                  ></span></button></span
                              ><span class="bcn-swac__tags"
                                ><span class="bcn-swac__tag">Avoidance &amp; BMPs</span
                                ><span class="bcn-swac__tag">Pre-Construction</span
                                ><span class="bcn-swac__tag">Construction</span
                                ><span class="bcn-swac__tag">Maintenance</span></span
                              ><span class="bcn-swcb" aria-label="9 linked requirements">9</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="approved">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install ESA fencing and identification signage"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ><span class="bcn-swac__tag">Avoidance &amp; BMPs</span
                                ><span class="bcn-swac__tag">Pre-Construction</span
                                ><span class="bcn-swac__tag">Construction</span></span
                              ><span class="bcn-swcb" aria-label="3 linked requirements">3</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              class="bcn-swac__main"
                              role="button"
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install exclusion barriers at work areas and shaft openings"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><button
                                type="button"
                                class="bcn-swac__approve"
                                title="Approve action"
                                aria-label="Approve action"
                              >
                                <span class="bcn-swac__pill"
                                  ><span class="bcn-swac__dot" aria-hidden="true"></span>Draft</span
                                ></button
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Remove exclusion barriers after covered activities end"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ><span class="bcn-swac__tag">Avoidance &amp; BMPs</span
                                ><span class="bcn-swac__tag">Construction</span
                                ><span class="bcn-swac__tag">Post-Construction</span></span
                              ><span class="bcn-swcb" aria-label="2 linked requirements">2</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Excavate and collapse burrows ahead of trenching"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ...
                                ><span class="bcn-swac__tag">Pre-Construction</span
                                ><span class="bcn-swac__tag">Construction</span></span
                              ><span class="bcn-swcb" aria-label="4 linked requirements">4</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Block burrows after confirming vacancy"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ...
                                ><span class="bcn-swac__tag">Construction</span
                                ><span class="bcn-swac__tag">Maintenance</span></span
                              ><span class="bcn-swcb" aria-label="6 linked requirements">6</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Dewater aquatic habitat and hold the dry period"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install wildlife under-crossing culverts and speed limit signage"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                                  >Install wildlife under-crossing culverts and speed limit
                                  signage</span
                                ><button
                                  type="button"
                                  class="bcn-swac__edit"
                              ...
                              ><span class="bcn-swac__tags"
                                ...
                                ><span class="bcn-swac__tag">Pre-Construction</span
                                ><span class="bcn-swac__tag">Construction</span
                                ><span class="bcn-swac__tag">Operations</span
                                ><span class="bcn-swac__tag">Maintenance</span></span
                              ><span class="bcn-swcb" aria-label="2 linked requirements">2</span
                              ><button
                                type="button"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install visual barriers along night access routes"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ><span class="bcn-swac__tag">Avoidance &amp; BMPs</span
                                ><span class="bcn-swac__tag">Construction</span></span
                              ><span class="bcn-swcb" aria-label="1 linked requirements">1</span
                              ><button
                                type="button"
                                class="bcn-swac__delete"
                                title="Delete action"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Delineate and sign occupied nest and roost buffers"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__tags"
                                ...
                                ><span class="bcn-swac__tag">Pre-Construction</span
                                ><span class="bcn-swac__tag">Construction</span
                                ><span class="bcn-swac__tag">Post-Construction</span
                                ><span class="bcn-swac__tag">Maintenance</span></span
                              ><span class="bcn-swcb" aria-label="2 linked requirements">2</span
                              ><button
                                type="button"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Clean and decontaminate equipment at each work site"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Prepare the hazardous materials management plan"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Conduct daily clearance surveys before work begins"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Conduct hydroacoustic monitoring during in-water pile driving"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                                  >Conduct hydroacoustic monitoring during in-water pile
                                  driving</span
                                ><button
                                  type="button"
                                  class="bcn-swac__edit"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Complete fish salvage and relocation before in-water work"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install erosion and sediment controls ahead of storms"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Cover open excavations at the close of each working day"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Obtain agency approval of designated wildlife handlers"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install Bird Strike Diverters on New Transmission Lines"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Install Erosion and Sediment Control Measures Before Earth-Moving"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                                  >Install Erosion and Sediment Control Measures Before
                                  Earth-Moving</span
                                ><button
                                  type="button"
                                  class="bcn-swac__edit"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Delineate Covered Species Habitat and Fence Construction Sites"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                              ...
                              ><span class="bcn-swac__title-group"
                                ><span class="bcn-swac__name"
                                  >Delineate Covered Species Habitat and Fence Construction
                                  Sites</span
                                ><button
                                  type="button"
                                  class="bcn-swac__edit"
                          ...
                          <li class="bcn-swac" data-status="draft">
                            <div
                              ...
                              tabindex="0"
                              aria-expanded="false"
                              aria-label="Expand Flag and Sign Cross-Country Access Routes"
                            >
                              <span class="bcn-swac__chevron" aria-hidden="true"
                                ><span class="esa-icon esa-icon--md" aria-hidden="true"
                                  ><svg
                      ...
                      <footer class="bcn-swb__foot bcn-swb__foot--split">
                        <div class="sw-legend">
                          <span class="sw-legend__stat"
                            ><span class="sw-legend__dot sw-legend__dot--approved"></span>2
                            Approved</span
                          ><span class="sw-legend__sep">·</span
                          ><span class="sw-legend__stat"
                            ><span class="sw-legend__dot sw-legend__dot--draft"></span>20
                            Draft</span
                          >
                        </div>
                        <div class="sw-foot-verbs">
                          <span
                            ...
                            ><button
                              class="esa-button__native typography-microcopy-2xs"
                              type="button"
                              title="Approve every Draft action in the current view"
                            >
                              <span class="esa-button__label"
                                ><span class="sw-verb"
                                  ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                          ...
                          ><span
                            ...
                            ><button
                              class="esa-button__native typography-microcopy-2xs"
                              type="button"
                              title="Delete every Draft action in the current view (Approved actions are unaffected)"
                            >
                              <span class="esa-button__label"
                                ><span class="sw-verb"
                                  ><span class="esa-icon esa-icon--xs" aria-hidden="true"
                ...
                <esa-side-dialog
                  ...
                  ><div slot="header" class="bcn-swaed__head">
                    <h2 class="bcn-swaed__title typography-title-strong">
                      Conduct North Delta Intake Fish Screen Hydraulic Tests
                    </h2>
                    <span
                      class="esa-badge esa-badge--secondary esa-badge--sm typography-microcopy-xs-strong"
                      ><span class="esa-badge__text">Draft</span></span
                    >
                  </div>
                  <div class="bcn-swaed__body">
                    <aside class="bcn-swaed__rail">
                      <header class="bcn-swaed__rail-head">
                        <h3 class="bcn-swaed__rail-title typography-label-md-strong">
                          Linked requirements
                        </h3>
                        <span
                          class="esa-badge esa-badge--secondary esa-badge--sm typography-microcopy-xs-strong"
                      ...
                      <ul class="bcn-swaed__rail-list">
                        <li class="bcn-swaed__rail-item">
                          ...
                          <p class="bcn-swaed__rail-name typography-body-sm">
                            Conduct Scheduled Fish Screen Hydraulic Tests
                          </p>
                        </li>
                        <li class="bcn-swaed__rail-item">
                          <span class="bcn-cbadge bcn-cbadge--sm">COA 10.27.1</span>
                          <p class="bcn-swaed__rail-name typography-body-sm">
                            Conduct Fish Screen Testing per NMFS 2023 Guidance
                          </p>
                        </li>
                        <li class="bcn-swaed__rail-item">
                          <span class="bcn-cbadge bcn-cbadge--sm">COA 11.109</span>
                          <p class="bcn-swaed__rail-name typography-body-sm">
                            Conduct Regular Hydraulic Testing of Screen Velocities
                          </p>
                        </li>
                      </ul>
                    </aside>
                    <section class="bcn-swaed__detail">
                      <esa-tab-layout
                        tabs='[{"label":"Details"},{"label":"Timing"},{"label":"Evidence"}]'
                        active-index="1"
                        size="md"
                        variant="underline"
                        ...
                        ><div slot="panel-0" class="bcn-swaed__panel">
                          <esa-text-field
                            label="Name"
                            value="Conduct North Delta Intake Fish Screen Hydraulic Tests"
                            size="md"
                          ></esa-text-field>
                        ...
                        <div slot="panel-1" class="bcn-swaed__panel">
                          <div class="bcn-swaed__timing-group">
                            <esa-button-toggle
                              label="Deadline"
                              options='[{"label":"Specific date","value":"specific"},{"label":"Relative to a milestone","value":"relative"}]'
                              value="relative"
                              size="md"
                            ></esa-button-toggle
                            ><esa-text-field
                              label="Milestone"
                              value="Phase 1 Operations"
                              size="md"
                            ></esa-text-field>
                          </div>
                          <div class="bcn-swaed__timing-group">
                            <esa-button-toggle
                              label="Cadence"
                              options='[{"label":"One time","value":"one-time"},{"label":"Recurring","value":"recurring"}]'
                              value="one-time"
                              size="md"
                            ></esa-button-toggle
                            ><esa-text-field
                          ...
                          <esa-textarea
                            label="Stated schedule"
                            value="a minimum of three tests during Phase 1 or Phase 2 operations: one test during a low river flow, another during a high diversion flow event, and the third during a normal operating condition"
                            rows="3"
                            auto-resize=""
                            disabled=""
                            size="md"
                        ...
                        <div slot="panel-2" class="bcn-swaed__panel">
                          <esa-textarea
                            ...
                            value="Hydraulic Testing Report for each of the three flow conditions, with velocity measurements taken per NMFS 2023 guidance and the screen-face visual inspection notes."
                            rows="4"
                            auto-resize=""
                            size="md"
                          ></esa-textarea></div
                ...
                <script
                  type="module"
                  src="/beacon-design/_astro/BcnSwActionsEditDialog.astro_astro_type_script_index_0_lang.C0bdExls.js"
                ></script>
              </div>
            </div>
          </section>
...
[data-theme="beacon"] {
  ...
  --bcn-aldo-100: #cfeceb;
  --bcn-aldo-50: #e8f6f5;
  --bcn-flag-on-bg: #fff3e0;
  --bcn-flag-on-color: #b05000;
  --bcn-gray-100: #efefef;
  --bcn-gray-200: #dcdcdc;
  --bcn-gray-300: #bdbdbd;
  --bcn-gray-400: #989898;
  ...
  --typography-microcopy-2xs-font-size: clamp(0.5rem, 0.44rem + 0.3vw, 0.625rem);
  --typography-microcopy-2xs-font-weight: 500;
  --typography-microcopy-2xs-letter-spacing: 0.01em;
  ...
  --typography-title-strong-font-family: "DM Sans", sans-serif;
  --typography-title-strong-font-size: clamp(1rem, 0.88rem + 0.6vw, 1.25rem);
  --typography-title-strong-font-weight: 550;
  --typography-title-strong-letter-spacing: 0.01em;
...
| `--bcn-flag-on-bg` | `#fff3e0` | component |
| `--bcn-flag-on-color` | `#b05000` | component |
...
| `--color-success-100` | `#dcfce7` | component |
| `--color-success-200` | `#bbf7d0` | component |
| `--color-success-50` | `#f0fdf4` | component |
...
| `--typography-title-strong-font-family` | `"DM Sans", sans-serif` | semantic |
| `--typography-title-strong-font-size` | `clamp(1rem, .88rem + .6vw, 1.25rem)` | semantic |
| `--typography-title-strong-font-weight` | `550` | semantic |
| `--typography-title-strong-letter-spacing` | `.01em` | semantic |
| `--typography-title-strong-line-height` | `1.6` | semantic |
