...
Edit details, Add actions (the checkbox drawer), Add evidence (the bottom evidence drawer in list mode).
...
<div class="cluster bcn-list-actions" data-gap="sm" data-list-actions="">
  <span
    ...
    >
      ...
      ><span class="esa-button__label">Edit details</span>
    </button></span
  ><span
    class="esa-button esa-button--variant-ghost esa-button--appearance-outline esa-button--sm"
    ><button
      class="esa-button__native typography-microcopy-xs"
      type="button"
      data-list-add-obligations="true"
      data-list-add-event="list:add-members"
    >
      <span class="esa-icon esa-icon--sm" aria-hidden="true"
        ><svg
          width="16"
      ...
      ><span class="esa-button__label">Add actions</span>
    </button></span
  ><span
    class="esa-button esa-button--variant-ghost esa-button--appearance-outline esa-button--sm"
    ><button
...
- `--justify`: flex-start _(component)_
