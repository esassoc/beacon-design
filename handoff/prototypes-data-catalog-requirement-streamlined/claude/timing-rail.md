...
.bcn-context__doc .esa-icon{color:var(--color-content-default-tertiary)}
...
.bcn-reqref__key .esa-icon{--_icon-size:11px;color:var(--color-content-default-tertiary);flex-shrink:0}
