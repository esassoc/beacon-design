...
`beacon` theme of the **prototypes-data-catalog-requirements-streamlined** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/data-catalog-requirements-streamlined/
      ...
      <div class="main-nav">
        <div class="nav-section nav-section--active">
          ...
          <ul class="nav-section__items">
            ...
            <li class="nav-item"><a href="#dc-terms" class="nav-sublink">Terms</a></li>
            <li class="nav-item">
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><span class="breadcrumb-item" aria-current="page">Requirements</span>
            </div>
          </nav>
        </section>
        <div class="page-layout__container">
          <section class="page-layout__title">
            <div class="page-layout__title-main"><h1>Requirements</h1></div>
          </section>
                        ...
                        <div class="ag-header-viewport" role="rowgroup" tabindex="-1">
                          ...
                          >
                            <div
                              ...
                              tabindex="0"
                              aria-rowindex="1"
                              style="top: 0px; height: 48px; width: 2170px"
                            >
                              <div
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              data-ref="eContainer"
                              role="presentation"
                              style="width: 2170px; height: 5720px"
                            >
                              <div
                                role="row"
                                comp-id="57"
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            data-ref="eContainer"
                            style="width: 2170px; height: 16px; max-height: 16px; min-height: 16px"
                          ></div>
                        </div>
                        <div
      ...
      <script type="application/json" id="dc-grid-data">
        {
          "rows": [
            {
              ...
              "species": "",
              "constructionActivities": "Demolition, Site preparation"
            },
            {
            ...
            },
            {
              ...
              "resourceCategory": "Biological Resources",
              "phase": "Pre-Construction",
              "species": "Roosting bats",
              "constructionActivities": "Demolition, Tree removal"
            },
            {
            ...
            },
            {
              ...
              "phase": "Construction",
              "species": "",
              "constructionActivities": "Earthwork, Hauling"
            },
            {
            ...
            },
            {
              ...
              "phase": "Pre-Construction",
              "species": "",
              "constructionActivities": "Tree removal"
            },
            {
            ...
            },
            {
              ...
              "phase": "Pre-Construction",
              "species": "",
              "constructionActivities": "Tree removal, Grading"
            },
            {
          ...
          "detailHref": "/beacon-design/prototypes/data-catalog-requirement-streamlined"
        }
      </script>
    </div>
  </div>
        ...
        <div class="bcn-gd-msg__group">
          <section class="bcn-gd__section">
            ...
            <div class="bcn-gd__here">
              <span class="bcn-gd__here-page" data-gd-page="">Requirements</span
              ><span class="bcn-gd__here-purpose" data-gd-purpose=""
                >The specific, actionable sub-obligations broken out of commitments — each traceable
                back to its source language.</span
              >
            </div>
          </section>
...
.grid-header{justify-content:space-between;align-items:center;gap:var(--spacing-400);margin-bottom:var(--spacing-300);display:flex}
.grid-header__filter{align-items:center;gap:var(--spacing-150);min-width:280px;display:inline-flex}
