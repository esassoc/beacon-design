...
<section class="ctb" aria-label="Clear-to-build timeline">
  ...
  <div class="ctb__axisrow" aria-hidden="true">
    ...
    <div class="ctb__axis" id="ctb-axis">
      ...
      ><span class="ctb-tick ctb-tick--today" style="left: 55.1913%">Today</span>
    </div>
    <span></span>
  </div>
  <ul class="ctb__rows" id="ctb-rows">
    ...
    <li class="ctb-row">
      ...
      <span class="ctb-row__track"
        ><span
          class="ctb-row__bar"
          style="left: 55.19125683060109%; width: 0.5%; background: var(--st-submitted)"
        ></span>
        <span
          class="ctb-row__dot"
