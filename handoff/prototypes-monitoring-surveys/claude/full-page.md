...
`beacon` theme of the **prototypes-monitoring-surveys** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/monitoring/surveys/
- **Section element:** `<page>`
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-filter-clear-button (hub), esa-filter-container (hub), esa-icon (hub), esa-loading-spinner (hub), esa-pill (hub)
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><a class="breadcrumb-item" href="/beacon-design/prototypes/monitoring/dashboard"
                >Monitoring Portal</a
              ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                ><svg
                  width="16"
                ...
                >
                  <path d="m9 18 6-6-6-6"></path></svg></span
              ><a class="breadcrumb-item" href="/beacon-design/prototypes/monitoring/data">Data</a
              ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                ><svg
                  width="16"
                  height="16"
                ...
                >
                  <path d="m9 18 6-6-6-6"></path></svg></span
              ><span class="breadcrumb-item" aria-current="page">Surveys</span>
            </div>
          </nav>
        </section>
          ...
          <section class="page-layout__content">
            <div class="bcn-filterbar">
              <div class="bcn-filterbar__top">
                ...
                <div class="bcn-filterbar__search">
                  <esa-text-field
                    ...
                    size="md"
                  ></esa-text-field
                  ><span id="sv-search-clear" hidden=""
                    ><span
              ...
              <div class="bcn-filterbar__bottom">
                ...
                <span id="sv-clear-filters" class="bcn-filterbar__clear"
                  ><button
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <!--AG-GRID-BODY-->
                    <div
                      class="ag-root ag-unselectable ag-layout-normal ag-body-horizontal-content-no-gap"
                      data-ref="eGridRoot"
                      role="grid"
                      aria-colcount="9"
                      aria-rowcount="11"
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            tabindex="0"
                            aria-rowindex="1"
                            style="top: 0px; height: 48px; width: 120px"
                          >
                            <div
                        ...
                        <div class="ag-header-viewport" role="rowgroup" tabindex="-1">
                          ...
                          >
                            <div
                              ...
                              tabindex="0"
                              aria-rowindex="1"
                              style="top: 0px; height: 48px; width: 1284px"
                            >
                              <div
                      ...
                      <div class="ag-body ag-layout-normal" data-ref="eBody" role="presentation">
                        ...
                        >
                          ...
                          <div
                            ...
                            role="rowgroup"
                            aria-hidden="false"
                            style="height: 440px; width: 120px; max-width: 120px; min-width: 120px"
                          >
                            <div
                              role="row"
                              comp-id="62"
                            ...
                            >
                              ...
                              >
                                <a class="bcn-grid-name" href="#">2026-05-18</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-04</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-05-29</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-03</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-02</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-10</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-09</a>
                              </div>
                            </div>
                            <div
                              role="row"
                            ...
                            >
                              <div
                                ...
                                style="left: 0px; width: 120px"
                              >
                                <a class="bcn-grid-name" href="#">2026-06-15</a>
                              </div>
                            </div>
                          </div>
                          <!--AG-ROW-CONTAINER-->
                          ...
                          >
                            <div
                              ...
                              data-ref="eContainer"
                              role="presentation"
                              style="width: 1284px; height: 440px"
                            >
                              <div
                                role="row"
                                comp-id="82"
                              ...
                              >
                                ...
                                <div
                                  ...
                                  tabindex="-1"
                                  aria-colindex="7"
                                  style="left: 900px; width: 130px"
                                >
                                  <span class="bcn-grid-chip" style="--_chip: #2e7571"
                              ...
                              >
                                ...
                                >
                                  <span class="bcn-grid-chip" style="--_chip: #f59e0b"
                                    ><span class="bcn-grid-chip__dot"></span>In QC</span
                                  >
                                </div>
                              </div>
                              <div
                          ...
                          <div
                            ...
                            role="rowgroup"
                            aria-hidden="true"
                            style="height: 440px; width: 0px; max-width: 0px; min-width: 0px"
                          ></div>
                          <!--AG-ROW-CONTAINER-->
                          <div
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              data-ref="eContainer"
                              style="height: 440px; width: 16px; max-width: 16px; min-width: 16px"
                            ></div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            data-ref="eContainer"
                            style="width: 1284px; height: 16px; max-height: 16px; min-height: 16px"
                          ></div>
                        </div>
                        <div
            ...
            <div class="table-footer">
              ...
              <div class="row-count-data">
                Total surveys: <span id="sv-total">12</span
                ><span id="sv-filtered" class="filtered-rows-count">Showing: 10</span>
              </div>
            </div>
          </section>
        </div>
      </div>
      <script type="application/json" id="sv-grid-data">
        {
          "rows": [
            {
              "date": "2026-05-18",
              "surveyor": "Christy Pierce",
              "surveyType": "Preconstruction Clearance Survey",
              "source": "Fulcrum",
              "species": "Swainson’s Hawk",
              "workArea": "DCTR2-DH-010",
              "status": "final",
              "complianceKey": "flag"
            },
            {
              "date": "2026-06-04",
              "surveyor": "Bryce Kozak",
              "surveyType": "Nesting Bird Survey",
              "source": "Fulcrum",
              "species": "Common Raven",
              "workArea": "DCRAI-DH-009",
              "status": "final",
              "complianceKey": "flag"
            },
            {
              "date": "2026-05-29",
              "surveyor": "Aaron Lopez",
              "surveyType": "Nesting Bird Survey",
              "source": "Fulcrum",
              "species": "Common Raven",
              "workArea": "DCRAI-DH-006",
              "status": "final",
              "complianceKey": "ok"
            },
            {
              "date": "2026-06-03",
              "surveyor": "Michael Morales",
              "surveyType": "Nesting Bird Survey",
              "source": "Fulcrum",
              "species": "Killdeer",
              "workArea": "DCTR2-DH-100",
              "status": "qc",
              "complianceKey": "flag"
            },
            {
            ...
            {
              "date": "2026-06-02",
              "surveyor": "Mackenzie Firestone",
              "surveyType": "Nesting Bird Survey",
              "source": "Fulcrum",
              "species": "Mallard",
              "workArea": "DCRDS-DH-294",
              "status": "final",
              "complianceKey": "ok"
            },
            {
              "date": "2026-06-04",
              "surveyor": "Carole Garrett",
              "surveyType": "SWHA Foraging Survey",
              "source": "Fulcrum",
              "species": "Swainson’s Hawk",
              "workArea": "DCRAI-DH-006",
              "status": "final",
            ...
            },
            {
              "date": "2026-06-10",
              "surveyor": "Mackenzie Firestone",
              "surveyType": "CASP Protocol Survey",
              "source": "CASP",
            ...
            {
              "date": "2026-06-09",
              "surveyor": "Alicia Manzo",
              "surveyType": "Two-week Clearance Survey",
              "source": "Survey123",
              "species": "General biological",
              "workArea": "DCRAI-DH-012",
              "status": "final",
              "complianceKey": "ok"
            },
            {
              "date": "2026-06-15",
              "surveyor": "Morgan Henry",
              "surveyType": "Habitat Assessment",
              "source": "Fulcrum",
              "species": "Rodent burrows",
              "workArea": "DCBPP-DH-066",
              "status": "qc",
              "complianceKey": "na"
            },
            {
              "date": "2026-06-12",
              "surveyor": "CJ January",
              "surveyType": "SWHA 72-hour Survey",
              "source": "Fulcrum",
              "species": "Swainson’s Hawk",
              "workArea": "DCTR2-DH-010",
              "status": "draft",
        ...
        <div class="bcn-gd-msg__group">
          <section class="bcn-gd__section">
            ...
            <div class="bcn-gd__here">
              <span class="bcn-gd__here-page" data-gd-page="">Surveys</span
              ><span class="bcn-gd__here-purpose" data-gd-purpose=""
                >Field survey records synced from collection apps, quality-controlled before they
                count toward compliance.</span
              >
            </div>
          </section>
...
[data-theme="beacon"] {
  ...
  --typography-microcopy-md-strong-font-family: "DM Sans", sans-serif;
  --typography-microcopy-md-strong-font-size: clamp(.75rem, .66rem + .44vw, .9375rem);
  --typography-microcopy-md-strong-font-weight: 550;
  --typography-microcopy-md-strong-letter-spacing: .01em;
  ...
  --typography-microcopy-sm-font-family: "DM Sans", sans-serif;
  --typography-microcopy-sm-font-size: clamp(.6875rem, .61rem + .38vw, .875rem);
  --typography-microcopy-sm-font-weight: 500;
  --typography-microcopy-sm-letter-spacing: .01em;
  --typography-microcopy-sm-line-height: 1;
...
.nav-section--collapsed .nav-section__items{opacity:0;max-height:0}
...
.esa-filter-container{align-items:center;gap:var(--_filter-container-row-gap,.5rem) var(--_filter-container-gap,.75rem);padding:var(--filter-container-padding,0);flex-wrap:wrap;display:flex}
:host {
...
.bcn-filterbar__top{align-items:center;gap:var(--spacing-400);padding:var(--spacing-300) var(--spacing-400);flex-wrap:wrap;display:flex}
.bcn-filterbar__group{align-items:center;gap:var(--spacing-300);display:inline-flex}
.bcn-filterbar__label{font-size:var(--font-size-150);font-weight:var(--typography-font-weight-semibold);color:var(--color-content-default-tertiary);white-space:nowrap}
.bcn-filterbar__search{align-items:center;gap:var(--spacing-150);min-width:300px;margin-left:auto;display:inline-flex}
.bcn-filterbar__search esa-text-field{flex:1}
.bcn-filterbar__bottom{align-items:center;gap:var(--spacing-300);padding:var(--spacing-300) var(--spacing-400);border-top:1px solid var(--color-border-default);flex-wrap:wrap;display:flex}
.bcn-filterbar__clear{margin-left:auto}
.esa-filter-clear-button{--_clear-text:var(--color-content-default-secondary,#646464);--_clear-text-hover:var(--color-content-utility-danger,var(--color-content-brand,#2a7e3b));--_clear-icon-size:18px;align-items:center;gap:var(--spacing-100,.25rem);padding:var(--spacing-100,.25rem) var(--spacing-200,.5rem);border-radius:var(--radius-sm,.25rem);color:var(--_clear-text);cursor:pointer;text-underline-offset:2px;transition:color var(--transition-fast,.15s ease), background var(--transition-fast,.15s ease);background:0 0;border:none;text-decoration:underline;display:inline-flex}
...
.bcn-grid-name{color:var(--color-content-link);font-weight:var(--typography-font-weight-regular);font-variant-numeric:tabular-nums;text-decoration:underline}
...
| `--typography-microcopy-md-strong-font-family` | `"DM Sans", sans-serif` | semantic |
| `--typography-microcopy-md-strong-font-size` | `clamp(.75rem, .66rem + .44vw, .9375rem)` | semantic |
| `--typography-microcopy-md-strong-font-weight` | `550` | semantic |
