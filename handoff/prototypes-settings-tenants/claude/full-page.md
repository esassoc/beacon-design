...
`beacon` theme of the **prototypes-settings-tenants** design system (an ESA Ecology spoke).

- **Source prototype:** http://localhost:4399/beacon-design/prototypes/settings/tenants/
- **Section element:** `<page>`
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-form-field (hub), esa-icon (hub), esa-loading-spinner (hub), esa-pill (hub)
      ...
      <div class="main-nav">
        ...
        <div class="nav-section nav-section--collapsed">
          ...
          <ul class="nav-section__items">
            <li class="nav-item"><a href="#dashboard" class="nav-sublink active">Dashboard</a></li>
        ...
        <section class="page-layout__breadcrumbs">
          <nav class="breadcrumbs" aria-label="Breadcrumb">
            <div class="breadcrumbs__items">
              ...
              ><span class="breadcrumb-item" aria-current="page">Tenants</span>
            </div>
          </nav>
        </section>
          ...
          <section class="page-layout__title">
            <div class="page-layout__title-main">
              ...
              <span
                ...
                ><span class="esa-badge__text">All tenants</span></span
              >
            </div>
          </section>
            ...
            >
              <div class="bcn-settings-shell__rail stack" data-gap="lg">
                <div class="bcn-settings-shell__search">
                  ...
                  <script
                    type="module"
                    src="/beacon-design/_astro/BcnSettingsSearch.astro_astro_type_script_index_0_lang.DGY65-I9.js"
                  ></script>
                </div>
                <div class="bcn-settings-shell__nav-scroll">
                  <nav class="bcn-settings-nav" aria-label="Settings">
                    ...
                    >
                      <h2
                        class="typography-body-md bcn-settings-nav__aud"
                        id="settings-aud-esa-admin"
                      >
                      ...
                      <div class="bcn-settings-nav__group">
                        <h3
                          class="typography-label-xs bcn-settings-nav__zone"
                        ...
                        >
                          <li class="bcn-settings-nav__item">
                            <a
                              class="typography-body-sm bcn-settings-nav__link"
                              href="/beacon-design/prototypes/settings/terminology"
                              ><span class="bcn-settings-nav__page">Terminology</span></a
                            >
                          </li>
                          <li class="bcn-settings-nav__item">
                            <a
                        ...
                        <span class="bcn-settings-nav__aud-icon" aria-hidden="true"
                          ><span class="esa-icon esa-icon--sm" aria-hidden="true"
                            ...
                            >
                              ...
                              <path d="M10 18h4"></path></svg></span></span
                        >Tenant Admin
                      </h2>
                      <div class="bcn-settings-nav__group">
                        <h3
                        ...
                        >
                          <li class="bcn-settings-nav__item">
                            <a
                              class="typography-body-sm bcn-settings-nav__link"
                              href="/beacon-design/prototypes/settings/tenant-profile"
                              ><span class="bcn-settings-nav__page">Tenant Profile</span></a
                            >
                          </li>
                          <li class="bcn-settings-nav__item">
                            <a
                        ...
                        >
                          <li class="bcn-settings-nav__item">
                            <a
                              class="typography-body-sm bcn-settings-nav__link"
                              href="/beacon-design/prototypes/settings/notifications"
                              ><span class="bcn-settings-nav__page">Notifications</span></a
                            >
                          </li>
                          <li class="bcn-settings-nav__item">
                            <a
                        ...
                        >
                          ...
                          <li class="bcn-settings-nav__item">
                            <a
                              class="typography-body-sm bcn-settings-nav__link"
                              href="/beacon-design/prototypes/settings/data-catalog-display"
                              ><span class="bcn-settings-nav__page">Data Catalog Display</span></a
                            >
                          </li>
                        </ul>
                      </div>
              ...
              <div class="bcn-settings-shell__content" data-esa-surface="">
                <div class="stack" data-gap="xl">
                  <section id="sec-tenant-list" class="bcn-set">
                      ...
                      <div class="esa-card__header">
                        <div class="esa-card__header-content">
                          <div class="esa-card__titles">
                            <h3 class="esa-card__title typography-title-sm-strong">Tenants</h3>
                          </div>
                        </div>
                        <div class="esa-card__actions typography-label-md">
                          <span
                            ...
                            >
                              ...
                              ><span class="esa-button__label">New tenant</span>
                            </button></span
                          >
                        </div>
                      </div>
                      <div class="esa-card__body typography-body-md">
                        <div class="bcn-record-rows" data-record-rows="tenant-list">
                          <ul class="bcn-record-rows__list">
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="apt"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Alaska Power &amp; Telephone</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                                    ><code
                                      class="bcn-record-rows__code typography-code-sm"
                                      data-cell="subdomain"
                                      >apt</code
                                    ></span
                                  >
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">AWS</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="bonozoic"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Beyond Petrochemicals</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">CASP</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="cobalt-solar"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Cobalt Solar</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">CPUC</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="delta-conveyance"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Delta Conveyance</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">ESA</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="esa-ml"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">ESA Measure Library</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="nepa-demo"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">ESA NEPA Demo</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">GGB Highway &amp; Transportation</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="gridliance"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Gridliance Core Upgrades CIC</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="lebls"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">LEBLS</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="losvaqueros"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Los Vaqueros</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="prologis"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Prologis</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">SFO</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="sitesreservoir"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Sites Reservoir</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Tahoe Regional Planning Agency</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                            ...
                            <li
                              class="bcn-record-rows__row"
                              data-record-row=""
                              data-record-id="vista-grande"
                            >
                              <div class="bcn-record-rows__content">
                                <p class="bcn-record-rows__lead typography-body-md">
                                  <span data-cell="tenant">Vista Grande</span>
                                </p>
                                <p class="bcn-record-rows__meta typography-body-sm">
                                  <span class="bcn-record-rows__pair"
                                    ><span class="bcn-record-rows__label">Subdomain</span
                          ...
                          <esa-dialog data-record-dialog="true" size="md"
                            ><div class="stack" data-gap="md">
                              <esa-text-field
                                label="Tenant"
                                data-record-field="tenant"
                                size="md"
                              ></esa-text-field
                              ><esa-text-field
                                label="Subdomain"
                                data-record-field="subdomain"
                                size="md"
                              ></esa-text-field>
                            </div>
                            <div
                        ...
                        <script
                          type="module"
                          src="/beacon-design/_astro/BcnRecordRows.astro_astro_type_script_index_0_lang.akuvWdRn.js"
                        ></script>
                      </div>
                    </div>
                  </section>
                  <script
                    type="module"
                    src="/beacon-design/_astro/BcnSettingsSection.astro_astro_type_script_index_0_lang.jxn7MiRo.js"
                  ></script>
                </div>
              </div>
            </div>
            ...
            <esa-side-dialog
              ...
              ><div class="stack" data-gap="lg">
                ...
                ><esa-text-field
                  label="Subdomain"
                  placeholder="dcp"
                  help-text="Letters, numbers, hyphens; cannot be changed later"
                  size="md"
                ></esa-text-field>
                <div class="esa-form-field esa-form-field--md">
                  <label class="esa-form-field__label typography-label-md">Modules</label>
                  <div class="esa-form-field__input typography-body-md">
                    <div class="cluster" data-gap="xs">
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Commitment Library</span></span
                      ><span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Monitoring Dashboard</span></span
                      ><span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Scheduling</span></span
                      ><span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Compliance Tracking</span></span
                      ><span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Spatial Library</span></span
                      ><span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs"
                        ><span class="esa-pill__label">Reporting</span></span
                      >
                    </div>
                  </div>
                  <p class="esa-form-field__help typography-body-sm">
                    Modules control which product areas appear in the main menu.
                  </p>
                </div>
              </div>
              <div class="cluster" data-gap="sm" slot="footer" style="--justify: flex-end">
                ...
                ><span
                  ...
                  ><button class="esa-button__native typography-microcopy-xs" type="button">
                    <span class="esa-button__label">Create tenant</span>
                  </button></span
                >
              </div></esa-side-dialog
            >
...
[data-theme="beacon"] {
  ...
  --typography-code-sm-font-family: "Roboto Mono", ui-monospace, monospace;
  --typography-code-sm-font-size: clamp(0.6875rem, 0.61rem + 0.38vw, 0.875rem);
  --typography-code-sm-font-weight: 350;
  --typography-code-sm-letter-spacing: 0.01em;
  --typography-code-sm-line-height: 1.6;
...
| `--typography-code-sm-font-family` | `"Roboto Mono", ui-monospace, monospace` | semantic |
| `--typography-code-sm-font-size` | `clamp(.6875rem, .61rem + .38vw, .875rem)` | semantic |
| `--typography-code-sm-font-weight` | `350` | semantic |
| `--typography-code-sm-letter-spacing` | `.01em` | semantic |
| `--typography-code-sm-line-height` | `1.6` | semantic |
