...
- **Components:** esa-alert-box (hub), esa-badge (hub), esa-button (hub), esa-card (hub), esa-empty-state (hub), esa-form-field (hub), esa-icon (hub), esa-icon-button (hub), esa-loading-spinner (hub), esa-pill (hub)
                  ...
                  <section id="sec-tenant-list" class="bcn-set">
                    <div class="esa-card esa-card--outlined">
                      <div class="esa-card__header">
                        <div class="esa-card__header-content">
                          <div class="esa-card__titles">
                            <h3 class="esa-card__title">Tenants</h3>
                          </div>
                        </div>
                      ...
                      <div class="esa-card__body">
                        ...
                        <script
                          type="module"
                          src="/beacon-design/_astro/BcnRecordRows.astro_astro_type_script_index_0_lang.46IOQyBv.js"
                        ></script>
                      </div>
                    </div>
                  </section>
            ...
            >
              <div class="stack" data-gap="lg">
                ...
                <div class="esa-form-field esa-form-field--md">
                  <label class="esa-form-field__label"> Modules </label>
              ...
              <div class="cluster" data-gap="sm" slot="footer" style="--justify: flex-end">
                <span
                  class="esa-button esa-button--color-ghost esa-button--appearance-outline esa-button--sm"
                >
                  <button class="esa-button__native" type="button" id="new-tenant-cancel">
                    <span class="esa-button__label"> Cancel </span>
                  </button>
                </span>
                <span
...
| `--form-help-color` | `#7c7c7c` | component |
