        ...
        <div class="page-layout__container">
          <section class="page-layout__title">
            <div class="page-layout__title-main">
              ...
              >
                <span class="esa-badge__text">All tenants</span>
              </span>
            </div>
          </section>
            ...
            >
              <div class="bcn-settings-shell__rail stack" data-gap="lg">
                <div class="bcn-settings-shell__search">
                  ...
                  <script
                    type="module"
                    src="/beacon-design/_astro/BcnSettingsSearch.astro_astro_type_script_index_0_lang.CLe-g7bS.js"
                  ></script>
                </div>
              ...
              <div class="bcn-settings-shell__content" data-esa-surface="">
                <div class="stack" data-gap="xl">
                  <section id="sec-tenant-list" class="bcn-set">
                    <div class="esa-card esa-card--outlined">
                      ...
                      <div class="esa-card__body typography-body-md">
                              ...
                              <div class="bcn-record-rows__content">
                                ...
                                <p class="bcn-record-rows__meta type-body-small">
                                  <span class="bcn-record-rows__pair">
                                    ...
                                    <code
                                      class="bcn-record-rows__code type-code"
                                      data-cell="subdomain"
                                    >
                                      apt
                                    </code>
                        ...
                        <script
                          type="module"
                          src="/beacon-design/_astro/BcnRecordRows.astro_astro_type_script_index_0_lang.H7dLmOj5.js"
                        ></script>
                      </div>
                    </div>
                  </section>
                  <script
                    type="module"
                    src="/beacon-design/_astro/BcnSettingsSection.astro_astro_type_script_index_0_lang.DxSNaRr7.js"
                  ></script>
                </div>
              </div>
            </div>
                  ...
                  <div class="esa-form-field__input typography-body-md">
                    <div class="cluster" data-gap="xs">
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Commitment Library</span>
                      </span>
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Monitoring Dashboard</span>
                      </span>
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Scheduling</span>
                      </span>
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Compliance Tracking</span>
                      </span>
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Spatial Library</span>
                      </span>
                      <span class="esa-pill esa-pill--default esa-pill--sm typography-microcopy-xs">
                        <span class="esa-pill__label">Reporting</span>
                      </span>
                    </div>
                  </div>
...
[data-theme="beacon"] {
  ...
  --typography-code-sm-font-family: "DM Mono", monospace;
  ...
  --typography-label-font-family: "DM Sans", sans-serif;
  --typography-label-font-size: clamp(0.625rem, 0.56rem + 0.32vw, 0.75rem);
  --typography-label-font-weight: 500;
  --typography-label-letter-spacing: 0.01em;
  --typography-label-line-height: 1.6;
...
| `--typography-code-sm-font-family` | `"DM Mono", monospace` | semantic |
...
| `--typography-label-font-family` | `"DM Sans", sans-serif` | component |
| `--typography-label-font-size` | `clamp(.625rem, .56rem + .32vw, .75rem)` | component |
| `--typography-label-font-weight` | `500` | component |
| `--typography-label-letter-spacing` | `.01em` | component |
| `--typography-label-line-height` | `1.6` | component |
